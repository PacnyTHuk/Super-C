...
.export sub_0x018011_остановить_звуковой_движок
...
sub_8001_28_36:
sub_0x018011_остановить_звуковой_движок:
...
C - - - - - 0x018068 06:8058: AD 61 01  LDA ram_0161    ; номер звука
...
sub_8181:
C - - - - - 0x018191 06:8181: 20 AB FD  JSR sub_0x01FDBB_выбрать_второй_банк_с_данными_музыки
