...
C - - - - - 0x01801E 06:800E: 8D 6D 01  STA ram_016D
...
sub_80F0:
C - - - - - 0x018100 06:80F0: 8D 6C 01  STA ram_016C
...
C - - - - - 0x01812B 06:811B: 0D 6C 01  ORA ram_016C
...
sub_0x01814C:
C - - - - - 0x01814C 06:813C: AD 6D 01  LDA ram_016D
C - - - - - 0x01814F 06:813F: F0 11     BEQ bra_8152
C - - - - - 0x018151 06:8141: EE 73 01  INC ram_0173
C - - - - - 0x018154 06:8144: AD 73 01  LDA ram_0173
C - - - - - 0x018157 06:8147: CD 6D 01  CMP ram_016D
C - - - - - 0x01815A 06:814A: D0 06     BNE bra_8152
C - - - - - 0x01815C 06:814C: A9 00     LDA #$00
C - - - - - 0x01815E 06:814E: 8D 73 01  STA ram_0173
C - - - - - 0x018161 06:8151: 60        RTS
bra_8152:
C - - - - - 0x018162 06:8152: A5 39     LDA ram_пауза
C - - - - - 0x018164 06:8154: CD 6C 01  CMP ram_016C
...
sub_8181:
C - - - - - 0x018191 06:8181: 20 AB FD  JSR sub_0x01FDBB
C - - - - - 0x018194 06:8184: AD 6C 01  LDA ram_016C
...
bra_8220:
C - - - - - 0x018230 06:8220: EE 67 01  INC ram_0167
C - - - - - 0x018233 06:8223: AD 67 01  LDA ram_0167
C - - - - - 0x018236 06:8226: 29 40     AND #$40
C - - - - - 0x018238 06:8228: D0 21     BNE bra_824B_RTS
C - - - - - 0x01823A 06:822A: AD 67 01  LDA ram_0167
...
C - - - - - 0x0186BA 06:86AA: 8D 67 01  STA ram_0167
C - - - - - 0x0186BD 06:86AD: AD 66 01  LDA ram_0166
...
C - - - - - 0x0186E3 06:86D3: 8D 8C 01  STA ram_018C
...
bra_89D2:
C - - - - - 0x0189E2 06:89D2: 8D 66 01  STA ram_0166
...
C - - - - - 0x018B33 06:8B23: 8D 6D 01  STA ram_016D
C - - - - - 0x018B36 06:8B26: A9 00     LDA #$00
C - - - - - 0x018B38 06:8B28: 8D 73 01  STA ram_0173
...
C - - - - - 0x018C9C 06:8C8C: 8E 8D 01  STX ram_018D
