...
C - - - - - 0x0045CB 01:85BB: 20 B8 F7  JSR sub_0x01F7C8_запись_фоновой_палитры_из_03E0x_в_0300x
...
ofs_038_12_85CD_03:
C - - J - - 0x0045DD 01:85CD: 20 EC A8  JSR sub_A8EC
...
C - - - - - 0x00415A 01:814A: 85 0A     STA ram_000A
                                        ...
                                        BCC bra_8154_выстрел_не_получился
...
; определить угол и повернуть пушки если надо
C - - - - - 0x004186 01:8176: 20 AE AA  JSR sub_0x006ABE_копировать_позиции_спрайта_объекта
...
C - - - - - 0x0148A4 05:8894: 20 95 F4  JSR sub_0x01F4A5_определить_угол_и_сравнить_между_собой
...
C - - - - - 0x0148CD 05:88BD: 20 AE AA  JSR sub_0x006ABE_копировать_позиции_спрайта_объекта
...
C - - - - - 0x014A3D 05:8A2D: 20 95 F4  JSR sub_0x01F4A5_определить_угол_и_сравнить_между_собой
...
C - - - - - 0x014A63 05:8A53: 20 AE AA  JSR sub_0x006ABE_копировать_позиции_спрайта_объекта
...
C - - - - - 0x00522D 01:921D: A9 F0     LDA #con_HP_F0
...
bra_9282:
C - - - - - 0x005292 01:9282: 20 EE A8  JSR sub_A8EE
...
bra_938F_loop:
C - - - - - 0x00539F 01:938F: A0 3A     LDY #con_obj_id_2A  ; пуля босса паука
...
C - - - - - 0x0059EF 01:99DF: A9 F0     LDA #con_HP_F0
...
C - - - - - 0x005C05 01:9BF5: 9D 56 07  STA ram_скролл_объекта_X,X  ; отложить 32bit HP
C - - - - - 0x005C08 01:9BF8: A9 F1     LDA #con_HP_F1  ; запретить урон
...
C - - - - - 0x005C6A 01:9C5A: 9D 76 06  STA ram_жизни_объектов_32bit,X  ; вернуть 32bit HP и разрешить урон
...
C - - - - - 0x005C85 01:9C75: 20 AE AA  JSR sub_0x006ABE_копировать_позиции_спрайта_объекта
...
C - - - - - 0x005C98 01:9C88: 9D 56 07  STA ram_скролл_объекта_X,X  ; отложить 32bit HP
C - - - - - 0x005C9B 01:9C8B: A9 F1     LDA #con_HP_F1  ; запретить урон
C - - - - - 0x005C9D 01:9C8D: 9D 76 06  STA ram_жизни_объектов_32bit,X
...
C - - - - - 0x005CB1 01:9CA1: 20 FD AB  JSR sub_0x006C0D_выбрать_кадр_анимации_исходя_из_счетчиков
...
C - - - - - 0x005CD0 01:9CC0: BD 84 06  LDA ram_дробная_скорость_объекта_y_младш,X
C - - - - - 0x005CD3 01:9CC3: 18        CLC
C - - - - - 0x005CD4 01:9CC4: 79 E7 9C  ADC tbl_9CE7_позиции,Y
C - - - - - 0x005CD7 01:9CC7: 9D 84 06  STA ram_дробная_скорость_объекта_y_младш,X
...
C - - - - - 0x005CE3 01:9CD3: BD 92 06  LDA ram_дробная_скорость_объекта_x_младш,X
C - - - - - 0x005CE6 01:9CD6: 18        CLC
C - - - - - 0x005CE7 01:9CD7: 79 E9 9C  ADC tbl_9CE7_позиции + $02,Y
C - - - - - 0x005CEA 01:9CDA: 9D 92 06  STA ram_дробная_скорость_объекта_x_младш,X
