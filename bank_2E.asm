...
C - - - - - 0x015336 05:9326: 9D 56 07  STA ram_скролл_объекта_X,X
...
C - - - - - 0x0112C2 04:92B2: BD 84 06  LDA ram_сумма_скорости_объекта_y_младш,X
C - - - - - 0x0112C5 04:92B5: 18        CLC
C - - - - - 0x0112C6 04:92B6: 7D A0 06  ADC ram_скорость_объектов_y_младш,X
C - - - - - 0x0112C9 04:92B9: 9D 84 06  STA ram_сумма_скорости_объекта_y_младш,X
...
C - - - - - 0x011DCA 04:9DBA: BD 84 06  LDA ram_сумма_скорости_объекта_y_младш,X
C - - - - - 0x011DCD 04:9DBD: 18        CLC
C - - - - - 0x011DCE 04:9DBE: 7D A0 06  ADC ram_скорость_объектов_y_младш,X
C - - - - - 0x011DD1 04:9DC1: 9D 84 06  STA ram_сумма_скорости_объекта_y_младш,X
...
C - - - - - 0x011DDD 04:9DCD: BD 92 06  LDA ram_сумма_скорости_объекта_x_младш,X
C - - - - - 0x011DE0 04:9DD0: 18        CLC
C - - - - - 0x011DE1 04:9DD1: 7D BC 06  ADC ram_скорость_объектов_x_младш,X
C - - - - - 0x011DE4 04:9DD4: 9D 92 06  STA ram_сумма_скорости_объекта_x_младш,X
...
C - - - - - 0x01181E 04:980E: A9 08     LDA #$08    ; счетчик
                                        STA ram_счетчики_для_объектов,X
                                        STA loc_0x0062E7_увеличить_состояние_объекта
