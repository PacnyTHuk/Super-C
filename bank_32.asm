...
sub_81E4:
C - - - - - 0x0041F4 01:81E4: A0 08     LDY #$08
sub_81E6:
...
C - - - - - 0x004270 01:8260: A5 5B     LDA ram_счетчик_кадров_2
...
C - - - - - 0x0042BB 01:82AB: A5 5B     LDA ram_счетчик_кадров_2
...
bra_860A:
C - - - - - 0x00461A 01:860A: A5 5B     LDA ram_счетчик_кадров_2
...
C - - - - - 0x004675 01:8665: 4C 90 89  JMP loc_8999_анимация_винтов_1босс
...
- D 0 - I - 0x0046D5 01:86C5: 09 87     .byte < ofs_013_8709_04
...
loc_8999_анимация_винтов_1босс:
; путин опт
...
C - - - - - 0x0052C3 01:92B3: A5 5B     LDA ram_счетчик_кадров_2
...
ofs_015_9B6B_02:
C - - J - - 0x005B7B 01:9B6B: A5 5B     LDA ram_счетчик_кадров_2
