...
C - - - - - 0x00417F 01:816F: 20 0B AB  JSR sub_0x006B1B
...
C - - - - - 0x004270 01:8260: A5 5B     LDA ram_005B
...
C - - - - - 0x0042BB 01:82AB: A5 5B     LDA ram_005B
...
ofs_038_21_8518_02:
C - - J - - 0x004528 01:8518: A5 61     LDA ram_0061
C - - - - - 0x00452A 01:851A: F0 FB     BEQ bra_8517_RTS
C - - - - - 0x00452C 01:851C: A5 60     LDA ram_0060
...
C - - - - - 0x004701 01:86F1: A5 94     LDA ram_0094
C - - - - - 0x004703 01:86F3: 09 40     ORA #$40
C - - - - - 0x004705 01:86F5: 85 94     STA ram_0094
...
loc_8990:
C D 0 - - - 0x0049A0 01:8990: A5 5B     LDA ram_005B
...
C - - - - - 0x004C6B 01:8C5B: BD 56 05  LDA ram_аттрибуты_спрайта_врага_и_пуль,X
...
ofs_038_26_8CA1_05:
C - - J - - 0x004CB1 01:8CA1: BD 56 05  LDA ram_аттрибуты_спрайта_врага_и_пуль,X
C - - - - - 0x004CB4 01:8CA4: 49 40     EOR #$40
C - - - - - 0x004CB6 01:8CA6: 9D 56 05  STA ram_аттрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x004CD1 01:8CC1: 20 0B AB  JSR sub_0x006B1B
...
bra_8CD0:
C - - - - - 0x004CE0 01:8CD0: 9D 56 05  STA ram_аттрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x004E37 01:8E27: A5 94     LDA ram_0094
C - - - - - 0x004E39 01:8E29: 09 40     ORA #$40
C - - - - - 0x004E3B 01:8E2B: 85 94     STA ram_0094
...
bra_8EA3:
- - - - - - 0x004EB3 01:8EA3: A5 94     LDA ram_0094
- - - - - - 0x004EB5 01:8EA5: 29 BF     AND #$BF
- - - - - - 0x004EB7 01:8EA7: 85 94     STA ram_0094
...
C - - - - - 0x004EC3 01:8EB3: A5 94     LDA ram_0094
C - - - - - 0x004EC5 01:8EB5: 29 BF     AND #$BF
C - - - - - 0x004EC7 01:8EB7: 85 94     STA ram_0094
...
C - - - - - 0x004EF5 01:8EE5: 9D 56 05  STA ram_аттрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x0051FB 01:91EB: 9D 56 05  STA ram_аттрибуты_спрайта_врага_и_пуль,X
...
ofs_038_4E_922A_02:
C - - J - - 0x00523A 01:922A: A5 61     LDA ram_0061
C - - - - - 0x00523C 01:922C: F0 36     BEQ bra_9264_RTS
C - - - - - 0x00523E 01:922E: A5 60     LDA ram_0060
...
C - - - - - 0x005425 01:9415: 20 0B AB  JSR sub_0x006B1B
...
C - - - - - 0x005505 01:94F5: 85 86     STA ram_0086
...
C - - - - - 0x005678 01:9668: E6 86     INC ram_0086
...
ofs_038_4B_99E7_02:
C - - J - - 0x0059F7 01:99E7: A5 61     LDA ram_0061
C - - - - - 0x0059F9 01:99E9: F0 22     BEQ bra_9A0D_RTS
C - - - - - 0x0059FB 01:99EB: A5 60     LDA ram_0060
...
ofs_038_4B_99FE_03:
C - - J - - 0x005A0E 01:99FE: A5 60     LDA ram_0060
...
ofs_038_4B_9A50_04:
C - - J - - 0x005A60 01:9A50: A5 60     LDA ram_0060
...
C - - - - - 0x005AE4 01:9AD4: 4C 37 A3  JMP loc_0x006347_delete_object_08
...
ofs_015_9B6B_02:
C - - J - - 0x005B7B 01:9B6B: A5 5B     LDA ram_005B
...
C - - - - - 0x005BA6 01:9B96: A5 5B     LDA ram_005B
...
C - - - - - 0x005CC6 01:9CB6: 9D 56 05  STA ram_аттрибуты_спрайта_врага_и_пуль,X
