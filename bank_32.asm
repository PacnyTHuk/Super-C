...
C - - - - - 0x00455B 01:854B: 8D F0 07  STA ram_chr_bank
C - - - - - 0x00455E 01:854E: A9 06     LDA #con_chr_bank + $06
C - - - - - 0x004560 01:8550: 8D F1 07  STA ram_chr_bank + $01
...
C - - - - - 0x004661 01:8651: 8D F0 07  STA ram_chr_bank
C - - - - - 0x004664 01:8654: A9 3A     LDA #con_chr_bank + $3A
C - - - - - 0x004666 01:8656: 8D F1 07  STA ram_chr_bank + $01
...
C - - - - - 0x005379 01:9369: A5 23     LDA ram_рандом_байт_1
...
C - - - - - 0x005A87 01:9A77: 8D F0 07  STA ram_chr_bank
C - - - - - 0x005A8A 01:9A7A: A9 18     LDA #con_chr_bank + $18
C - - - - - 0x005A8C 01:9A7C: 8D F1 07  STA ram_chr_bank + $01
...
C - - - - - 0x005B70 01:9B60: 8D F5 07  STA ram_chr_bank + $05
bra_9B63:
