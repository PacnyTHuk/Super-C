...
ofs_038_3A_91D1_02:
C - - J - - 0x0051E1 01:91D1: 20 B7 A6  JSR sub_0x0066C7_прибавить_позицию_спрайта_к_скорости_камеры_X_Y
...
C - - - - - 0x0051EB 01:91DB: 9D 08 05  STA ram_кадр_объекта_или_пули,X
C - - - - - 0x0051EE 01:91DE: 4C D7 A2  JMP loc_0x0062E7_увеличить_состояние_объекта
...
bra_91F8:
C - - - - - 0x005208 01:91F8: 20 D3 A6  JSR sub_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
...
C - - - - - 0x00522F 01:921F: 9D 76 06  STA ram_жизни_объектов_8bit,X
...
C - - - - - 0x0059F1 01:99E1: 9D 76 06  STA ram_жизни_объектов_8bit,X
...
C - - - - - 0x005C0A 01:9BFA: 9D 76 06  STA ram_жизни_объектов_8bit,X
...
C - - - - - 0x005C95 01:9C85: BD 76 06  LDA ram_жизни_объектов_8bit,X
