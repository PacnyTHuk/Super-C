...
C - - - - - 0x0141BD 05:81AD: 9D 2C 07  STA ram_состояние_хитбоксов_объектов,X
...
C - - - - - 0x0141F2 05:81E2: 20 D3 A6  JSR sub_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
C - - - - - 0x0141F5 05:81E5: DE F4 06  DEC ram_счетчкик_жизни_объектов,X
C - - - - - 0x0141F8 05:81E8: D0 03     BNE bra_81ED_RTS
C - - - - - 0x0141FA 05:81EA: 4C D7 A2  JMP loc_0x0062E7_увеличить_состояние_объекта
bra_81ED_RTS:
