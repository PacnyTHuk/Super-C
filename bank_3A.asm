...
C - - - - - 0x014050 05:8040: 9D 56 07  STA ram_scroll_X_obj,X
...
ofs_038_2E_8060_03:
C - - J - - 0x014070 05:8060: BC 56 07  LDY ram_scroll_X_obj,X
...
C - - - - - 0x014087 05:8077: BD 56 07  LDA ram_scroll_X_obj,X
...
C - - - - - 0x0140AD 05:809D: 20 0B AB  JSR sub_0x006B1B_выбрать_ближайшего_игрока_по_оси_x
C - - - - - 0x0140B0 05:80A0: 98        TYA
C - - - - - 0x0140B1 05:80A1: 9D 64 07  STA ram_0764_obj,X
C - - - - - 0x0140B4 05:80A4: 20 95 F4  JSR sub_0x01F4A5
bra_80A7:
C - - - - - 0x0140B7 05:80A7: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
bra_813A:
C - - - - - 0x01414A 05:813A: 9D E6 06  STA ram_счетчкики_для_объектов,X
bra_813D_RTS:
C - - - - - 0x01414D 05:813D: 60        RTS
bra_813E:
C - - - - - 0x01414E 05:813E: A9 60     LDA #$60
C - - - - - 0x014150 05:8140: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x01417D 05:816D: BC 56 07  LDY ram_scroll_X_obj,X
...
ofs_038_30_81DB_03:
C - - J - - 0x0141EB 05:81DB: A5 5B     LDA ram_счетчик_кадров_2
C - - - - - 0x0141ED 05:81DD: 29 01     AND #$01
C - - - - - 0x0141EF 05:81DF: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x01422E 05:821E: 9D 56 07  STA ram_scroll_X_obj,X
...
bra_8277:
C - - - - - 0x014287 05:8277: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x01428A 05:827A: D0 38     BNE bra_82B4_RTS
C - - - - - 0x01428C 05:827C: A9 0C     LDA #$0C
C - - - - - 0x01428E 05:827E: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x0142AA 05:829A: BD 56 07  LDA ram_scroll_X_obj,X
...
C - - - - - 0x0142BA 05:82AA: 9D 56 07  STA ram_scroll_X_obj,X
...
C - - - - - 0x0142D5 05:82C5: BC 56 07  LDY ram_scroll_X_obj,X
...
C - - - - - 0x01430C 05:82FC: BC 56 07  LDY ram_scroll_X_obj,X
...
C - - - - - 0x014350 05:8340: 9D 56 07  STA ram_scroll_X_obj,X
...
ofs_038_5C_834D_02:
C - - J - - 0x01435D 05:834D: BC 56 07  LDY ram_scroll_X_obj,X
...
C - - - - - 0x014392 05:8382: 65 5B     ADC ram_счетчик_кадров_2
C - - - - - 0x014394 05:8384: 85 23     STA ram_рандом_байт
...
bra_838E:
C - - - - - 0x01439E 05:838E: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x0143A1 05:8391: D0 0F     BNE bra_83A2_RTS
C - - - - - 0x0143A3 05:8393: A9 08     LDA #$08
C - - - - - 0x0143A5 05:8395: 9D E6 06  STA ram_счетчкики_для_объектов,X
C - - - - - 0x0143A8 05:8398: 20 0B AB  JSR sub_0x006B1B_выбрать_ближайшего_игрока_по_оси_x
...
C - - - - - 0x0143CB 05:83BB: BC 56 07  LDY ram_scroll_X_obj,X
...
loc_840E:
sub_840E:
C D 0 - - - 0x01441E 05:840E: BD 56 07  LDA ram_scroll_X_obj,X
...
C - - - - - 0x014484 05:8474: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x01450F 05:84FF: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
bra_8573:
C - - - - - 0x014583 05:8573: A5 1B     LDA ram_счетчик_кадров_1
C - - - - - 0x014585 05:8575: E5 23     SBC ram_рандом_байт
C - - - - - 0x014587 05:8577: 85 23     STA ram_рандом_байт
C - - - - - 0x014589 05:8579: A5 23     LDA ram_рандом_байт
...
C - - - - - 0x0145A4 05:8594: 9D 56 07  STA ram_scroll_X_obj,X
...
bra_85DD:
C - - - - - 0x0145ED 05:85DD: BC 56 07  LDY ram_scroll_X_obj,X
bra_85E0:
...
C - - - - - 0x01464A 05:863A: BD 56 07  LDA ram_scroll_X_obj,X
...
bra_8646:
C - - - - - 0x014656 05:8646: 9D 56 07  STA ram_scroll_X_obj,X
...
C - - - - - 0x014664 05:8654: 20 0B AB  JSR sub_0x006B1B_выбрать_ближайшего_игрока_по_оси_x
...
C - - - - - 0x0146A4 05:8694: 20 0B AB  JSR sub_0x006B1B_выбрать_ближайшего_игрока_по_оси_x
...
C - - - - - 0x0146E1 05:86D1: 65 1B     ADC ram_счетчик_кадров_1
...
bra_8723:
C - - - - - 0x014733 05:8723: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x014816 05:8806: 9D 56 07  STA ram_scroll_X_obj,X
...
C - - - - - 0x0148A7 05:8897: BC 56 07  LDY ram_scroll_X_obj,X
...
C - - - - - 0x0148B3 05:88A3: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x0148C1 05:88B1: BD 56 07  LDA ram_scroll_X_obj,X
...
C - - - - - 0x01490D 05:88FD: BC 56 07  LDY ram_scroll_X_obj,X
...
C - - - - - 0x0149CC 05:89BC: 9D E6 06  STA ram_счетчкики_для_объектов,X
bra_89BF:
...
C - - - - - 0x0149DC 05:89CC: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x014A23 05:8A13: 9D 56 07  STA ram_scroll_X_obj,X
...
C - - - - - 0x014A40 05:8A30: BC 56 07  LDY ram_scroll_X_obj,X
...
C - - - - - 0x014A57 05:8A47: BD 56 07  LDA ram_scroll_X_obj,X
...
C - - - - - 0x014AC9 05:8AB9: BC 56 07  LDY ram_scroll_X_obj,X
...
bra_8B59:
C - - - - - 0x014B69 05:8B59: A5 5B     LDA ram_счетчик_кадров_2
...
C - - - - - 0x014BDE 05:8BCE: 9D 56 07  STA ram_scroll_X_obj,X
...
C - - - - - 0x014BEA 05:8BDA: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x014C0C 05:8BFC: BC 56 07  LDY ram_scroll_X_obj,X
...
bra_8CF5:
C - - - - - 0x014D05 05:8CF5: 9D 56 07  STA ram_scroll_X_obj,X
...
bra_8D50:
C - - - - - 0x014D60 05:8D50: BD 56 07  LDA ram_scroll_X_obj,X
...
C - - - - - 0x014D75 05:8D65: BD 56 07  LDA ram_scroll_X_obj,X
...
C - - - - - 0x014D88 05:8D78: BD 56 07  LDA ram_scroll_X_obj,X
...
bra_8D81:
C - - - - - 0x014D91 05:8D81: BD 56 07  LDA ram_scroll_X_obj,X
...
bra_8D8D:
C - - - - - 0x014D9D 05:8D8D: 9D 56 07  STA ram_scroll_X_obj,X
...
C - - - - - 0x014DA8 05:8D98: 1D 56 07  ORA ram_scroll_X_obj,X
...
C - - - - - 0x014E20 05:8E10: 9D 56 07  STA ram_scroll_X_obj,X
...
C - - - - - 0x014E2E 05:8E1E: BD 56 07  LDA ram_scroll_X_obj,X
C - - - - - 0x014E31 05:8E21: F0 15     BEQ bra_8E38
C - - - - - 0x014E33 05:8E23: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x014E36 05:8E26: D0 10     BNE bra_8E38
C - - - - - 0x014E38 05:8E28: A9 06     LDA #$06
C - - - - - 0x014E3A 05:8E2A: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x014E45 05:8E35: DE 56 07  DEC ram_scroll_X_obj,X
bra_8E38:
...
C - - - - - 0x014E79 05:8E69: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
ofs_038_39_8E70_03:
C - - J - - 0x014E80 05:8E70: BD E6 06  LDA ram_счетчкики_для_объектов,X
C - - - - - 0x014E83 05:8E73: F0 05     BEQ bra_8E7A
C - - - - - 0x014E85 05:8E75: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
ofs_038_39_8EBB_06:
C - - J - - 0x014ECB 05:8EBB: A5 5B     LDA ram_счетчик_кадров_2
C - - - - - 0x014ECD 05:8EBD: 29 03     AND #$03
C - - - - - 0x014ECF 05:8EBF: D0 0F     BNE bra_8ED0
C - - - - - 0x014ED1 05:8EC1: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x014ED4 05:8EC4: D0 0A     BNE bra_8ED0
C - - - - - 0x014ED6 05:8EC6: A9 80     LDA #$80
C - - - - - 0x014ED8 05:8EC8: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
bra_9138:
C - - - - - 0x015148 05:9138: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x0151DF 05:91CF: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x01525F 05:924F: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x0152BC 05:92AC: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
bra_92BF:
C - - - - - 0x0152CF 05:92BF: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x0152ED 05:92DD: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x0155EF 05:95DF: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x01573B 05:972B: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
bra_975B:
C - - - - - 0x01576B 05:975B: 9D E6 06  STA ram_счетчкики_для_объектов,X
bra_975E:
...
C - - - - - 0x01579A 05:978A: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x0157E6 05:97D6: BD 56 07  LDA ram_scroll_X_obj,X
...
C - - - - - 0x0157F9 05:97E9: BD 56 07  LDA ram_scroll_X_obj,X
C - - - - - 0x0157FC 05:97EC: 49 01     EOR #$01
C - - - - - 0x0157FE 05:97EE: 9D 56 07  STA ram_scroll_X_obj,X
