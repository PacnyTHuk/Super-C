...
C - - - - - 0x0082B5 02:82A5: 4C D7 A2  JMP loc_0x0062E7_увеличить_состояние_объекта
...
C - - - - - 0x0082C2 02:82B2: 4C D3 A6  JMP loc_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
...
- - - - - - 0x00854B 02:853B: 9D 08 05  STA ram_кадр_объекта_или_пули,X
- - - - - - 0x00854E 02:853E: A9 81     LDA #$81
- - - - - - 0x008550 02:8540: 9D 2C 07  STA ram_состояние_хитбоксов_объектов,X
...
- - - - - - 0x008570 02:8560: 79 3C 05  ADC ram_позиция_x_спрайта_объекта_или_пули,Y
- - - - - - 0x008573 02:8563: 9D 3C 05  STA ram_позиция_x_спрайта_объекта_или_пули,X
- - - - - - 0x008576 02:8566: A5 00     LDA ram_0000
- - - - - - 0x008578 02:8568: 18        CLC
- - - - - - 0x008579 02:8569: 79 22 05  ADC ram_позиция_y_спрайта_объекта_или_пули,Y
- - - - - - 0x00857C 02:856C: 9D 22 05  STA ram_позиция_y_спрайта_объекта_или_пули,X
- - - - - - 0x00857F 02:856F: 4C D7 A2  JMP loc_0x0062E7_увеличить_состояние_объекта
...
bra_8A7D:
C - - - - - 0x008A8D 02:8A7D: 4C D7 A2  JMP loc_0x0062E7_увеличить_состояние_объекта
...
C - - - - - 0x008AB5 02:8AA5: 20 D3 A6  JSR sub_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
