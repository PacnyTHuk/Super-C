...
- D 0 - I - 0x00801B 02:800B: 3D A3     .word ofs_038_45_0x00634D_06_удалить_объект_04 ; 
...
C - - - - - 0x008022 02:8012: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
C - - - - - 0x008025 02:8015: BD 1E 07  LDA ram_obj_flags,X
C - - - - - 0x008028 02:8018: 29 03     AND #$03
C - - - - - 0x00802A 02:801A: A8        TAY
C - - - - - 0x00802B 02:801B: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x00802E 02:801E: 18        CLC
C - - - - - 0x00802F 02:801F: 79 31 80  ADC tbl_8031,Y
C - - - - - 0x008032 02:8022: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008035 02:8025: BD 3C 05  LDA ram_позиция_x_спрайта_врага_и_пуль,X
C - - - - - 0x008038 02:8028: 38        SEC
C - - - - - 0x008039 02:8029: E9 08     SBC #$08
C - - - - - 0x00803B 02:802B: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
...
ofs_038_45_8035_02:
C - - J - - 0x008045 02:8035: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
C - - - - - 0x008048 02:8038: BD 3C 05  LDA ram_позиция_x_спрайта_врага_и_пуль,X
C - - - - - 0x00804B 02:803B: C9 F0     CMP #$F0
C - - - - - 0x00804D 02:803D: B0 13     BCS bra_8052_RTS
C - - - - - 0x00804F 02:803F: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
...
ofs_038_45_8053_03:
C - - J - - 0x008063 02:8053: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008066 02:8056: C9 D0     CMP #$D0
C - - - - - 0x008068 02:8058: 90 03     BCC bra_805D
C - - - - - 0x00806A 02:805A: 4C 75 A2  JMP loc_0x006285_удалить_объект_02
bra_805D:
C - - - - - 0x00806D 02:805D: A9 01     LDA #$01
C - - - - - 0x00806F 02:805F: 9D 08 05  STA ram_кадр_врага_и_пуль,X
C - - - - - 0x008072 02:8062: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
...
C - - - - - 0x00807F 02:806F: BD 56 07  LDA ram_scroll_X_obj,X
...
bra_80AF:
loc_80AF:
C D 0 - - - 0x0080BF 02:80AF: BD 56 07  LDA ram_scroll_X_obj,X
C - - - - - 0x0080C2 02:80B2: 49 01     EOR #$01
C - - - - - 0x0080C4 02:80B4: 9D 56 07  STA ram_scroll_X_obj,X
bra_80B7:
...
- D 0 - I - 0x008144 02:8134: 3D A3     .word ofs_038_46_0x00634D_07_удалить_объект_04 ; 
...
C - - - - - 0x008155 02:8145: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x008165 02:8155: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x008168 02:8158: D0 46     BNE bra_81A0_RTS
C - - - - - 0x00816A 02:815A: A9 20     LDA #$20
C - - - - - 0x00816C 02:815C: 9D 56 07  STA ram_scroll_X_obj,X
...
C - - - - - 0x008179 02:8169: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
C - - - - - 0x00817C 02:816C: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x008193 02:8183: BD 56 07  LDA ram_scroll_X_obj,X
C - - - - - 0x008196 02:8186: F0 15     BEQ bra_819D
C - - - - - 0x008198 02:8188: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x00819B 02:818B: D0 10     BNE bra_819D
C - - - - - 0x00819D 02:818D: A9 07     LDA #$07
C - - - - - 0x00819F 02:818F: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x0081AA 02:819A: DE 56 07  DEC ram_scroll_X_obj,X
bra_819D:
...
- D 0 - I - 0x0081BB 02:81AB: 3D A3     .word ofs_038_2A_0x00634D_06_удалить_объект_04 ; 
...
ofs_038_2A_81CC_02:
C - - J - - 0x0081DC 02:81CC: BD E6 06  LDA ram_счетчкики_для_объектов,X
...
bra_81D7:
C - - - - - 0x0081E7 02:81D7: 9D 08 05  STA ram_кадр_врага_и_пуль,X
C - - - - - 0x0081EA 02:81DA: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
C - - - - - 0x0081ED 02:81DD: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x008208 02:81F8: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
- D 0 - I - 0x00821E 02:820E: 3D A3     .word ofs_038_47_0x00634D_05_удалить_объект_04 ; 
...
C - - - - - 0x008227 02:8217: 9D 56 07  STA ram_scroll_X_obj,X
C - - - - - 0x00822A 02:821A: BD 3C 05  LDA ram_позиция_x_спрайта_врага_и_пуль,X
C - - - - - 0x00822D 02:821D: 38        SEC
C - - - - - 0x00822E 02:821E: E9 08     SBC #$08
C - - - - - 0x008230 02:8220: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
C - - - - - 0x008233 02:8223: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008236 02:8226: 18        CLC
C - - - - - 0x008237 02:8227: 69 08     ADC #$08
C - - - - - 0x008239 02:8229: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x00823C 02:822C: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
...
ofs_038_47_8234_02:
C - - J - - 0x008244 02:8234: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008247 02:8237: C9 D0     CMP #$D0
C - - - - - 0x008249 02:8239: 90 03     BCC bra_823E
C - - - - - 0x00824B 02:823B: 4C 75 A2  JMP loc_0x006285_удалить_объект_02
bra_823E:
C - - - - - 0x00824E 02:823E: A9 01     LDA #$01
C - - - - - 0x008250 02:8240: 9D 08 05  STA ram_кадр_врага_и_пуль,X
C - - - - - 0x008253 02:8243: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
C - - - - - 0x008256 02:8246: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x00827D 02:826D: DE 56 07  DEC ram_scroll_X_obj,X
C - - - - - 0x008280 02:8270: 10 07     BPL bra_8279
C - - - - - 0x008282 02:8272: A9 01     LDA #$01
C - - - - - 0x008284 02:8274: 9D 56 07  STA ram_scroll_X_obj,X
C - - - - - 0x008287 02:8277: A9 50     LDA #$50
bra_8279:
C - - - - - 0x008289 02:8279: 9D E6 06  STA ram_счетчкики_для_объектов,X
bra_827C_RTS:
...
C - - - - - 0x0082A8 02:8298: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
...
C - - - - - 0x0082BA 02:82AA: 9D 08 05  STA ram_кадр_врага_и_пуль,X
C - - - - - 0x0082BD 02:82AD: A9 02     LDA #$02
C - - - - - 0x0082BF 02:82AF: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x00835D 02:834D: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
...
; 1путин опт
                                        INC ram_002B
C - - - - - 0x008383 02:8373: 4C 75 A2  JMP loc_0x006285_удалить_объект_02



sub_8376:
C - - - - - 0x008386 02:8376: BD 3C 05  LDA ram_позиция_x_спрайта_врага_и_пуль,X
C - - - - - 0x008389 02:8379: 38        SEC
C - - - - - 0x00838A 02:837A: E5 62     SBC ram_cam_spd_X
C - - - - - 0x00838C 02:837C: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
...
C - - - - - 0x0083BC 02:83AC: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x0083BF 02:83AF: 38        SEC
C - - - - - 0x0083C0 02:83B0: E5 08     SBC ram_0008
C - - - - - 0x0083C2 02:83B2: 85 9A     STA ram_009A
C - - - - - 0x0083C4 02:83B4: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
...
bra_83C2:
loc_83C2:
C D 0 - - - 0x0083D2 02:83C2: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
ofs_017_83C9_01:
C - - J - - 0x0083D9 02:83C9: BD E6 06  LDA ram_счетчкики_для_объектов,X
C - - - - - 0x0083DC 02:83CC: 29 03     AND #$03
C - - - - - 0x0083DE 02:83CE: D0 0D     BNE bra_83DD
C - - - - - 0x0083E0 02:83D0: BD E6 06  LDA ram_счетчкики_для_объектов,X
...
bra_83DD:
C - - - - - 0x0083ED 02:83DD: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
ofs_017_83E6_02:
C - - J - - 0x0083F6 02:83E6: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x008407 02:83F7: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x00840A 02:83FA: C9 21     CMP #$21
C - - - - - 0x00840C 02:83FC: B0 CA     BCS bra_83C8_RTS
C - - - - - 0x00840E 02:83FE: A9 20     LDA #$20
C - - - - - 0x008410 02:8400: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
...
C - - - - - 0x008425 02:8415: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008428 02:8418: B9 34 84  LDA tbl_8434_pos_X,Y
C - - - - - 0x00842B 02:841B: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
...
ofs_017_843A_04:
C - - J - - 0x00844A 02:843A: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
sub_8448:
C - - - - - 0x008458 02:8448: BD 84 06  LDA ram_позиция_врага_y_младш,X
C - - - - - 0x00845B 02:844B: 18        CLC
C - - - - - 0x00845C 02:844C: 7D A0 06  ADC ram_скорость_объектов_y_младш,X
C - - - - - 0x00845F 02:844F: 9D 84 06  STA ram_позиция_врага_y_младш,X
C - - - - - 0x008462 02:8452: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008465 02:8455: 7D AE 06  ADC ram_скорость_объектов_y_старш,X
C - - - - - 0x008468 02:8458: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
...
- D 0 - I - 0x008485 02:8475: 75 A2     .word ofs_038_2B_0x006285_04_удалить_объект_02 ; 
...
ofs_038_2B_8492_02:
C - - J - - 0x0084A2 02:8492: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x0084A5 02:8495: D0 08     BNE bra_849F_RTS
C - - - - - 0x0084A7 02:8497: A9 02     LDA #$02
C - - - - - 0x0084A9 02:8499: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
- D 0 - I - 0x0084C3 02:84B3: 3D A3     .word ofs_038_37_0x00634D_06_удалить_объект_04 ; 



ofs_038_37_84B5_01_initialize_object:
C - - J - - 0x0084C5 02:84B5: A9 03     LDA #$03
C - - - - - 0x0084C7 02:84B7: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
C - - - - - 0x0084CA 02:84BA: A9 B8     LDA #$B8
C - - - - - 0x0084CC 02:84BC: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x0084CF 02:84BF: A9 D0     LDA #$D0
C - - - - - 0x0084D1 02:84C1: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
...
C - - - - - 0x0084E9 02:84D9: 65 1B     ADC ram_счетчик_кадров_1
...
- - - - - - 0x008547 02:8537: 75 A2     .word ofs_038_38_0x006285_03_удалить_объект_02 ; 
...
- - - - - - 0x008561 02:8551: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
- - - - - - 0x008570 02:8560: 79 3C 05  ADC ram_позиция_x_спрайта_врага_и_пуль,Y
- - - - - - 0x008573 02:8563: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
- - - - - - 0x008576 02:8566: A5 00     LDA ram_0000
- - - - - - 0x008578 02:8568: 18        CLC
- - - - - - 0x008579 02:8569: 79 22 05  ADC ram_позиция_y_спрайта_врага_и_пуль,Y
- - - - - - 0x00857C 02:856C: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
- - - - - - 0x00857F 02:856F: 4C D7 A2  JMP loc_0x0062E7_increase_obj_state



ofs_038_38_8572_02:
- - - - - - 0x008582 02:8572: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
- - - - - - 0x00858E 02:857E: DE 56 07  DEC ram_scroll_X_obj,X
- - - - - - 0x008591 02:8581: D0 07     BNE bra_858A
- - - - - - 0x008593 02:8583: A9 02     LDA #$02
- - - - - - 0x008595 02:8585: 9D 56 07  STA ram_scroll_X_obj,X
- - - - - - 0x008598 02:8588: A9 F0     LDA #$F0
bra_858A:
- - - - - - 0x00859A 02:858A: 9D E6 06  STA ram_счетчкики_для_объектов,X
bra_858D_RTS:
...
C - - - - - 0x008618 02:8608: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x008638 02:8628: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x008650 02:8640: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
...
C - - - - - 0x008676 02:8666: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
...
C - - - - - 0x008688 02:8678: 9D 08 05  STA ram_кадр_врага_и_пуль,X
C - - - - - 0x00868B 02:867B: 20 90 88  JSR sub_8890
C - - - - - 0x00868E 02:867E: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008691 02:8681: C9 5A     CMP #$5A
C - - - - - 0x008693 02:8683: 90 19     BCC bra_869E
C - - - - - 0x008695 02:8685: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x008698 02:8688: D0 13     BNE bra_869D_RTS
C - - - - - 0x00869A 02:868A: A9 01     LDA #$01
C - - - - - 0x00869C 02:868C: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x0086AA 02:869A: 99 56 07  STA ram_scroll_X_obj,Y
bra_869D_RTS:
...
C - - - - - 0x0086C6 02:86B6: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x00870C 02:86FC: 9D 56 07  STA ram_scroll_X_obj,X
C - - - - - 0x00870F 02:86FF: A9 30     LDA #$30
C - - - - - 0x008711 02:8701: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
sub_8727:
C - - - - - 0x008737 02:8727: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
bra_873F:
C - - - - - 0x00874F 02:873F: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x008784 02:8774: DE 56 07  DEC ram_scroll_X_obj,X
...
C - - - - - 0x008790 02:8780: 9D 56 07  STA ram_scroll_X_obj,X
...
ofs_038_6E_8933_02:
C - - J - - 0x008943 02:8933: BD E6 06  LDA ram_счетчкики_для_объектов,X
C - - - - - 0x008946 02:8936: F0 04     BEQ bra_893C
C - - - - - 0x008948 02:8938: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
- D 0 - I - 0x008963 02:8953: 3D A3     .word ofs_038_3B_0x00634D_06_удалить_объект_04 ; 
...
C - - - - - 0x00897D 02:896D: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
C - - - - - 0x008980 02:8970: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
...
C - - - - - 0x0089BC 02:89AC: 7D 56 07  ADC ram_scroll_X_obj,X
...
C - - - - - 0x0089D1 02:89C1: DE 56 07  DEC ram_scroll_X_obj,X
C - - - - - 0x0089D4 02:89C4: A4 12     LDY ram_0012
C - - - - - 0x0089D6 02:89C6: BD 3C 05  LDA ram_позиция_x_спрайта_врага_и_пуль,X
...
C - - - - - 0x008A1D 02:8A0D: 7D 3C 05  ADC ram_позиция_x_спрайта_врага_и_пуль,X
C - - - - - 0x008A20 02:8A10: 99 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,Y
C - - - - - 0x008A23 02:8A13: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008A26 02:8A16: 38        SEC
C - - - - - 0x008A27 02:8A17: E9 10     SBC #$10
C - - - - - 0x008A29 02:8A19: 99 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,Y
bra_8A1C:
...
bra_8A34:
C - - - - - 0x008A44 02:8A34: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
- - - - - - 0x008A50 02:8A40: 75 A2     .word ofs_038_3C_0x006285_03_удалить_объект_02 ; 
...
C - - - - - 0x008A6D 02:8A5D: A5 23     LDA ram_рандом_байт
...
C - - - - - 0x008A81 02:8A71: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x008AD0 02:8AC0: 4C 75 A2  JMP loc_0x006285_удалить_объект_02
bra_8AC3_RTS:
...
- D 0 - I - 0x008ADE 02:8ACE: 3D A3     .word ofs_038_3D_0x00634D_06_удалить_объект_04 ; 
...
C - - - - - 0x008AE5 02:8AD5: BD 3C 05  LDA ram_позиция_x_спрайта_врага_и_пуль,X
C - - - - - 0x008AE8 02:8AD8: 38        SEC
C - - - - - 0x008AE9 02:8AD9: E9 08     SBC #$08
C - - - - - 0x008AEB 02:8ADB: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
C - - - - - 0x008AEE 02:8ADE: A9 01     LDA #$01
C - - - - - 0x008AF0 02:8AE0: 9D 10 07  STA ram_0710_obj,X
C - - - - - 0x008AF3 02:8AE3: A9 03     LDA #$03
C - - - - - 0x008AF5 02:8AE5: 9D 56 07  STA ram_scroll_X_obj,X
C - - - - - 0x008AF8 02:8AE8: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
...
C - - - - - 0x008B02 02:8AF2: 9D 08 05  STA ram_кадр_врага_и_пуль,X
C - - - - - 0x008B05 02:8AF5: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
C - - - - - 0x008B08 02:8AF8: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
bra_8B28:
C - - - - - 0x008B38 02:8B28: 9D E6 06  STA ram_счетчкики_для_объектов,X
bra_8B2B_RTS:
C - - - - - 0x008B3B 02:8B2B: 60        RTS
bra_8B2C:
C - - - - - 0x008B3C 02:8B2C: DE 56 07  DEC ram_scroll_X_obj,X
C - - - - - 0x008B3F 02:8B2F: D0 F2     BNE bra_8B23
C - - - - - 0x008B41 02:8B31: A9 06     LDA #$06
C - - - - - 0x008B43 02:8B33: 9D 56 07  STA ram_scroll_X_obj,X
C - - - - - 0x008B46 02:8B36: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
...
ofs_038_3D_8B45_03:
C - - J - - 0x008B55 02:8B45: 20 B7 A6  JSR sub_0x0066C7_удалить_объект_03
C - - - - - 0x008B58 02:8B48: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x008B72 02:8B62: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008B75 02:8B65: 38        SEC
C - - - - - 0x008B76 02:8B66: E9 08     SBC #$08
C - - - - - 0x008B78 02:8B68: 99 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,Y
bra_8B6B:
C - - - - - 0x008B7B 02:8B6B: DE 10 07  DEC ram_0710_obj,X
C - - - - - 0x008B7E 02:8B6E: A9 20     LDA #$20
C - - - - - 0x008B80 02:8B70: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
sub_8B85:
C - - - - - 0x008B95 02:8B85: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
...
- D 0 - I - 0x008BB8 02:8BA8: 3D A3     .word ofs_038_3E_0x00634D_05_удалить_объект_04 ; 
...
C - - - - - 0x008BE7 02:8BD7: BD 3C 05  LDA ram_позиция_x_спрайта_врага_и_пуль,X
...
bra_8BE6:
C - - - - - 0x008BF6 02:8BE6: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x008C70 02:8C60: BD 56 05  LDA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x008CC9 02:8CB9: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
...
ofs_038_52_8CC6_02:
C - - J - - 0x008CD6 02:8CC6: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
bra_8CF1:
loc_8CF1:
C D 0 - - - 0x008D01 02:8CF1: 9D E6 06  STA ram_счетчкики_для_объектов,X
bra_8CF4_RTS:
...
ofs_038_52_8D1A_04:
C - - J - - 0x008D2A 02:8D1A: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x008D42 02:8D32: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x008D5C 02:8D4C: 4C 3D A3  JMP loc_0x00634D_удалить_объект_04
...
bra_8DE2:
C - - - - - 0x008DF2 02:8DE2: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
C - - - - - 0x008DF5 02:8DE5: A9 27     LDA #$27
C - - - - - 0x008DF7 02:8DE7: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
...
C - - - - - 0x008DFF 02:8DEF: 9D 08 05  STA ram_кадр_врага_и_пуль,X
C - - - - - 0x008E02 02:8DF2: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x008E0E 02:8DFE: 9D E6 06  STA ram_счетчкики_для_объектов,X
bra_8E01_RTS:
...
C - - J - - 0x008E15 02:8E05: 4C 3D A3  JMP loc_0x00634D_удалить_объект_04
...
- D 0 - I - 0x008E22 02:8E12: 3D A3     .word ofs_038_54_0x00634D_06_удалить_объект_04 ; 
...
C - - - - - 0x008E38 02:8E28: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
- D 0 - I - 0x008E59 02:8E49: 3D A3     .word ofs_038_55_0x00634D_05_удалить_объект_04 ; 
...
C - - - - - 0x008E81 02:8E71: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
C - - - - - 0x008E84 02:8E74: A9 20     LDA #$20
C - - - - - 0x008E86 02:8E76: 9D 56 07  STA ram_scroll_X_obj,X
...
C - - - - - 0x008E97 02:8E87: BD 56 07  LDA ram_scroll_X_obj,X
C - - - - - 0x008E9A 02:8E8A: F0 15     BEQ bra_8EA1
C - - - - - 0x008E9C 02:8E8C: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x008E9F 02:8E8F: D0 10     BNE bra_8EA1
C - - - - - 0x008EA1 02:8E91: A9 06     LDA #$06
C - - - - - 0x008EA3 02:8E93: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x008EAE 02:8E9E: DE 56 07  DEC ram_scroll_X_obj,X
bra_8EA1:
...
- D 0 - I - 0x008EC6 02:8EB6: 3D A3     .word ofs_038_56_0x00634D_0A_удалить_объект_04 ; 
...
ofs_038_56_8EC0_02:
C - - J - - 0x008ED0 02:8EC0: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x008ED3 02:8EC3: D0 3B     BNE bra_8F00_RTS
C - - - - - 0x008ED5 02:8EC5: A9 0C     LDA #$0C
C - - - - - 0x008ED7 02:8EC7: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x008EFB 02:8EEB: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008EFE 02:8EEE: A9 05     LDA #$05
C - - - - - 0x008F00 02:8EF0: 9D 56 07  STA ram_scroll_X_obj,X
...
C - - - - - 0x008F29 02:8F19: BD 3C 05  LDA ram_позиция_x_спрайта_врага_и_пуль,X
...
C - - - - - 0x008F3B 02:8F2B: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x008F3E 02:8F2E: D0 D0     BNE bra_8F00_RTS
C - - - - - 0x008F40 02:8F30: A9 30     LDA #$30
C - - - - - 0x008F42 02:8F32: 9D E6 06  STA ram_счетчкики_для_объектов,X
C - - - - - 0x008F45 02:8F35: 20 C9 8F  JSR sub_8FC9
C - - - - - 0x008F48 02:8F38: DE 56 07  DEC ram_scroll_X_obj,X
...
ofs_038_56_8F51_05:
C - - J - - 0x008F61 02:8F51: DE E6 06  DEC ram_счетчкики_для_объектов,X
C - - - - - 0x008F64 02:8F54: D0 AA     BNE bra_8F00_RTS
C - - - - - 0x008F66 02:8F56: A9 0C     LDA #$0C
C - - - - - 0x008F68 02:8F58: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x008F7A 02:8F6A: 9D 08 05  STA ram_кадр_врага_и_пуль,X
...
C - - - - - 0x008FB4 02:8FA4: 9D 08 05  STA ram_кадр_врага_и_пуль,X
C - - - - - 0x008FB7 02:8FA7: BC 10 07  LDY ram_0710_obj,X
C - - - - - 0x008FBA 02:8FAA: BD 22 05  LDA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x008FBD 02:8FAD: 18        CLC
C - - - - - 0x008FBE 02:8FAE: 79 C2 8F  ADC tbl_8FC2,Y
C - - - - - 0x008FC1 02:8FB1: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
...
bra_8FBE:
C - - - - - 0x008FCE 02:8FBE: 9D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль,X
...
C - - - - - 0x008FEA 02:8FDA: BD 3C 05  LDA ram_позиция_x_спрайта_врага_и_пуль,X
...
C - - - - - 0x00902F 02:901F: 9D 08 05  STA ram_кадр_врага_и_пуль,X
...
C - - - - - 0x00903F 02:902F: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x009042 02:9032: A9 80     LDA #$80
C - - - - - 0x009044 02:9034: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
...
ofs_038_51_9080_04:
C - - J - - 0x009090 02:9080: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
bra_90AB:
loc_90AB:
C D 0 - - - 0x0090BB 02:90AB: 9D E6 06  STA ram_счетчкики_для_объектов,X
bra_90AE_RTS:
...
ofs_038_51_90E6_06:
C - - J - - 0x0090F6 02:90E6: DE E6 06  DEC ram_счетчкики_для_объектов,X
...
C - - - - - 0x00910E 02:90FE: 9D E6 06  STA ram_счетчкики_для_объектов,X
...
C - - - - - 0x009298 02:9288: 20 9E F7  JSR sub_0x01F7AE_подготовить_объект
...
C - - - - - 0x0092A9 02:9299: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
...
bra_92A9:
C - - - - - 0x0092B9 02:92A9: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
...
loc_0x0092C0_подготовить_лопасти_вертолета_на_1м_уровне:
; bzk optimize, проверять на 1й уровень перед попаданием сюда
...
C - - - - - 0x0092CB 02:92BB: 20 9E F7  JSR sub_0x01F7AE_подготовить_объект
C - - - - - 0x0092CE 02:92BE: A9 60     LDA #$60
C - - - - - 0x0092D0 02:92C0: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
