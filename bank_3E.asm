...
C - - - - - 0x0092CB 02:92BB: 20 9E F7  JSR sub_F79E_записать_ID_объекта_и_его_хитбокс
...
C - - - - - 0x01F0B6 07:F0A6: 4C A4 FE  JMP sub_FEA4_подготовка_и_выбор_банков_для_перерисовки_части_фона_через_буфер
...
C - - - - - 0x01F54D 07:F53D: BD 48 07  LDA ram_скролл_объекта_Y,X
...
C - - - - - 0x01F55F 07:F54F: DD 48 07  CMP ram_скролл_объекта_Y,X
...
- D 3 - - - 0x01F8F4 07:F8E4: 00        .byte $00, $00, $04, $08, $00, $08, $04, $10, $00, $08, $00, $0C, $0C, $0C, $04, $00   ; 00
- D 3 - - - 0x01F904 07:F8F4: 00        .byte $00, $0C, $00, $00, $00, $00, $00, $00, $00, $0C, $04, $00, $04, $00, $00, $0C   ; 10
- D 3 - - - 0x01F914 07:F904: 0C        .byte $0C, $00, $00, $0C, $04, $08, $04, $18, $04, $00, $04, $1C, $04, $0C, $00, $00   ; 20
- D 3 - - - 0x01F924 07:F914: 04        .byte $08, $00, $00, $00, $00, $0C, $00, $0C, $04, $00, $00, $00, $00, $00, $0C, $00   ; 30
...
sub_FD58_смена_prg_банков_и_выбор_второго_банка:
loc_FD58_смена_prg_банков_и_выбор_второго_банка:
C D 3 - - - 0x01FD68 07:FD58: A4 50     LDY ram_номер_уровня
C - - - - - 0x01FD6A 07:FD5A: B9 C0 FD  LDA tbl_FDC0_prg_bank,Y
sub_FD5D_смена_prg_банков_на_30_33:  ; A = 30
...
C - - - - - 0x01FE2F 07:FE1F: 20 58 FD  JSR sub_FD58_смена_prg_банков_и_выбор_второго_банка
...
C - - - - - 0x01FE6F 07:FE5F: 20 6F FD  JSR sub_FD6F_смена_prg_банков_без_возврата
C - - - - - 0x01FE72 07:FE62: 20 61 92  JSR sub_0x001271_flame_разрыв
C - - - - - 0x01FE75 07:FE65: 4C 58 FD  JMP loc_FD58_смена_prg_банков_и_выбор_второго_банка
...
sub_0x01FE80_bankswitch_загрузка_палитры_в_03E0x:
...
C - - - - - 0x01FEC4 07:FEB4: 4C 58 FD  JMP loc_FD58_смена_prg_банков_и_выбор_второго_банка
