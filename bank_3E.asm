...
.export sub_0x001000_тест_рассчета_угла_выстрела
...
bra_1001:
                                        ...
                                        STA ram_7000    ; разница x

                                        ASL ram_7000    ; разница x
                                        ROL ram_7001    ; разница X HI
...
C - - - - - 0x01F692 07:F682: A5 0A     LDA ram_000A    ; индекс игрока
