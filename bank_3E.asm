...
.export sub_0x01F337
.export loc_0x01F337
.export sub_0x01F360_расчет_угла_выстрела
...
sub_0x01F360_расчет_угла_выстрела:
...
C - - - - - 0x01F535 07:F525: 85 0C     STA ram_000C    ; угол от объекта до игрока
bra_F527:
...
C - - - - - 0x01F5F1 07:F5E1: 85 0A     STA ram_000A    ; разница x 
...
C - - - - - 0x01F605 07:F5F5: 84 07     STY ram_0007    ; вращение
C - - - - - 0x01F607 07:F5F7: 4A        LSR
C - - - - - 0x01F608 07:F5F8: 85 0B     STA ram_000B    ; разница y 
...
C - - - - - 0x01F619 07:F609: A5 0A     LDA ram_000A    ; разница x 
C - - - - - 0x01F61B 07:F60B: 0A        ASL
C - - - - - 0x01F61C 07:F60C: 0A        ASL
C - - - - - 0x01F61D 07:F60D: 65 0B     ADC ram_000B    ; разница y
