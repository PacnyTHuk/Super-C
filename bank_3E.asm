...
.export loc_0x01F811_обнуление_пуль_игрока
.export sub_0x01F820
.export sub_0x01F860
.export tbl_0x01F8DC
.export tbl_0x01F8E8
...
loc_0x01F811_обнуление_пуль_игрока:
C D 3 - - - 0x01F811 07:F801: A9 00     LDA #$00
C - - - - - 0x01F816 07:F806: 9D 68 05  STA ram_тип_пули_игрока,X                 ; 60C0
                                        STA ram_пули_игрока_позиция_y_старш,X     ; 60E0
                                        STA ram_пули_игрока_позиция_x_старш,X     ; 6100               
C - - - - - 0x01F819 07:F809: 9D 98 05  STA ram_пули_игрока_атрибуты_спрайта,X    ; 6120
C - - - - - 0x01F813 07:F803: 9D A8 05  STA ram_пули_игрока_аттрибуты,X           ; 6140
                                        STA ram_пули_игрока_тип_анимации,X        ; 6160
                                        STA ram_пули_игрока_позиция_y_младш,X     ; 6180
                                        STA ram_пули_игрока_позиция_x_младш,X     ; 61A0
                                        STA ram_пули_игрока_скорость_y_младш,X    ; 61C0
                                        STA ram_пули_игрока_урон,X                ; 61E0
                                        STA ram_пули_игрока_скорость_x_младш,X    ; 6200
                                        STA ram_пули_игрока_скорость_x_старш,X    ; 6220
                                        STA ram_пули_игрока_счетчик_жизни,X       ; 6240
C - - - - - 0x01F81C 07:F80C: 9D 38 06  STA ram_пули_игрока_хитбокс,X             ; 6260
                                        STA ram_пули_игрока_направление,X         ; 6280
                                        STA ram_пули_игрока_скорость_y_старш,X    ; 62A0
