...
bra_8398:
C - - - - - 0x0143A8 05:8398: 20 0B AB  JSR sub_0x006AEB_выбрать_ближайшего_игрока_по_осям_X_Y
                                        JSR sub_0x006ABE_копировать_позиции_спрайта_объекта
                                        JSR sub_0x01F360_расчет_угла_от_объекта_до_игрока
                                        TYA
                                        STA ram_000E    ; сохраним угол от объекта до игрока 
                                        LSR
                                        LSR
                                        LSR
                                        LSR
                                        TAY
                                        LDA tbl_4444,Y
                                        CMP ram_счетчик_поворота_объекта,X
                                        BNE bra_838E_поворот_объекта
; угол совпал, можно стрелять
                                        LDA ram_счетчкик_жизни_объектов,X
                                        BNE bra_83A2_RTS
                                        LDY #con_obj_id_02  ; обычная пуля объекта
                                        JSR sub_0x006BF8_поиск_пустого_слота_и_попытка_создать_пулю_на_позиции_текущего_объекта
...
; есть свободный слот, пуля была создана
                                        JSR sub_0x01F360_определить_множитель_скорости_пули_от_сложности_игры
                                        LDY ram_000E    ; угол от объекта до игрока 
...
C - - - - - 0x014406 05:83F6: 20 AE AA  JSR sub_0x006ABE_копировать_позиции_спрайта_объекта
C - - - - - 0x014409 05:83F9: 20 F0 F4  JSR sub_0x01F500
C - - - - - 0x01440C 05:83FC: A5 0C     LDA ram_000C
C - - - - - 0x01440E 05:83FE: 9D 48 07  STA ram_скролл_объекта_Y,X
...
C D 0 - - - 0x01441E 05:840E: BD 56 07  LDA ram_скролл_объекта_X,X
...
C - - - - - 0x01447F 05:846F: 9D 48 07  STA ram_скролл_объекта_Y,X
...
C - - - - - 0x01459E 05:858E: 9D 48 07  STA ram_скролл_объекта_Y,X
C - - - - - 0x0145A1 05:8591: B9 AE 85  LDA tbl_85AE,Y
C - - - - - 0x0145A4 05:8594: 9D 56 07  STA ram_скролл_объекта_X,X
...
bra_85DD:
C - - - - - 0x0145ED 05:85DD: BC 56 07  LDY ram_скролл_объекта_X,X
bra_85E0:
...
sub_862B:
C - - - - - 0x01463B 05:862B: BD 48 07  LDA ram_скролл_объекта_Y,X
...
bra_8637:
C - - - - - 0x014647 05:8637: 9D 48 07  STA ram_скролл_объекта_Y,X
C - - - - - 0x01464A 05:863A: BD 56 07  LDA ram_скролл_объекта_X,X
...
bra_8646:
C - - - - - 0x014656 05:8646: 9D 56 07  STA ram_скролл_объекта_X,X
...
C - - - - - 0x0146AB 05:869B: 20 AE AA  JSR sub_0x006ABE_копировать_позиции_спрайта_объекта
C - - - - - 0x0146AE 05:869E: 20 F0 F4  JSR sub_0x01F500
C - - - - - 0x0146B1 05:86A1: A4 0C     LDY ram_000C
C - - - - - 0x0146B3 05:86A3: B9 D4 F4  LDA tbl_0x01F4E4_угол_поворота_объекта,Y
...
C - - - - - 0x01404B 05:803B: 9D 48 07  STA ram_скролл_объекта_Y,X
C - - - - - 0x01404E 05:803E: A9 03     LDA #$03
C - - - - - 0x014050 05:8040: 9D 56 07  STA ram_скролл_объекта_X,X
...
C - - - - - 0x01406A 05:805A: A9 10     LDA #$10    ; счетчик перед первым выстрелом из пушек
                                        STA ram_счетчики_для_объектов,X
                                        JMP loc_0x0062E7_увеличить_состояние_объекта
bra_805F_RTS:
...
ofs_038_1F_8060_03:
C - - J - - 0x014070 05:8060: BC 56 07  LDY ram_скролл_объекта_X,X
...
C - - - - - 0x014087 05:8077: BD 56 07  LDA ram_скролл_объекта_X,X
...
C - - - - - 0x014093 05:8083: 20 AE AA  JSR sub_0x006ABE_копировать_позиции_спрайта_объекта
...
C - - - - - 0x01417D 05:816D: BC 56 07  LDY ram_скролл_объекта_X,X
