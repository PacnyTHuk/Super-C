...
C - - - - - 0x007584 01:B574: 9D 3C 05  STA ram_позиция_x_спрайта_объекта_или_пули,X
                                        ...
                                        JSR sub_0x01F360_расчет_угла_выстрела
...
C - - - - - 0x01434B 05:833B: 9D 48 07  STA ram_скролл_объекта_Y,X
C - - - - - 0x01434E 05:833E: A9 03     LDA #$03
C - - - - - 0x014350 05:8340: 9D 56 07  STA ram_скролл_объекта_X,X
...
ofs_038_47_834D_02:
C - - J - - 0x01435D 05:834D: BC 56 07  LDY ram_скролл_объекта_X,X
...
C - - - - - 0x014379 05:8369: 20 AE AA  JSR sub_0x006ABE_копировать_позиции_спрайта_объекта
...
C - - - - - 0x0143CB 05:83BB: BC 56 07  LDY ram_скролл_объекта_X,X
...
C - - - - - 0x014706 05:86F6: 79 09 87  ADC tbl_8709_позиция_Y,Y
...
C - - - - - 0x014710 05:8700: 79 11 87  ADC tbl_8711_позиция_X,Y
