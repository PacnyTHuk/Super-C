...
- - - - - - 0x006F17 01:AF07: 4C B4 A6  JMP loc_0x00A6C4_прибавить_позицию_спрайта_к_скорости_камеры_Y
bra_AF0A:
...
- D 1 - I - 0x007886 01:B876: BC B8     .word ofs_038_0D_0x00B8BC_03 ; 
...
C - - - - - 0x014D7F 05:8D6F: A0 2D     LDY #con_obj_id_1E  ; блок_падающей_платформы
