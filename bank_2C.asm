...
C - - - - - 0x00753A 01:B52A: 20 27 F3  ;JSR sub_0x01F337
                                        ...
                                        JSR sub_0x006BD8_поиск_пустого_слота_и_попытка_создать_новый_объект_на_позиции_текущего_объекта
...
sub_B54D:
C - - - - - 0x00755D 01:B54D: D0 2A     BCC bra_B579_RTS
...
C - - - - - 0x007584 01:B574: 9D 3C 05  STA ram_позиция_x_спрайта_объекта_или_пули,X
                                        JSR sub_0x001000_тест_рассчета_угла_выстрела
