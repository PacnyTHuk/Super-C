...
bra_B06B:
C - - - - - 0x00707B 01:B06B: 4C FD AB  JMP loc_0x006C0D
bra_B06E_RTS:
...
C - - - - - 0x007198 01:B188: 20 D3 A6  JSR sub_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
...
C - - - - - 0x007411 01:B401: 20 FD AB  JSR sub_0x006C0D
...
C - - - - - 0x0143F6 05:83E6: 20 D3 A6  JSR sub_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
...
C - - - - - 0x014517 05:8507: 20 D3 A6  JSR sub_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
...
C - - - - - 0x01406A 05:805A: A9 10     LDA #$10    ; счетчик
                                        STA ram_счетчики_для_объектов,X
                                        JMP loc_0x0062E7_увеличить_состояние_объекта
bra_805F_RTS:
...
C - - - - - 0x0101F4 04:81E4: 20 D3 A6  JSR sub_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
...
C - - - - - 0x010217 04:8207: 20 D3 A6  JSR sub_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
...
C - - - - - 0x014DE5 05:8DD5: 20 D3 A6  JSR sub_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
