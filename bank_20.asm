...
.export loc_0x01EAC0_подготовить_начальные_банки_для_уровня
.export loc_0x00F894_загрузка_палитры_для_уровня
.export sub_0x00F896_загрузка_палитры
...
loc_0x01EAC0_подготовить_начальные_банки_для_уровня:
