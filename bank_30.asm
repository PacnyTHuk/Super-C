...
; пусто все, можно стрелять
                                        ...
                                        JMP loc_8D31_обработка_колво_патронов    ; 
...
loc_8D31_обработка_колво_патронов:
...
bra_8D33_loop:
                                        ...
                                        SEC
                                        CMP tbl_8D36_цена_за_выстрел,Y
                                        BCS bra_8D36_патронов_хватает
                                        DEC ram_колво_патронов_оружия_hi,X
                                        BPL bra_8D36_патронов_хватает
                                        LDA #$00
...
bra_8D34_RTS:
                                        RTS
bra_8D36_патронов_хватает:
                                        SEC
                                        SBC tbl_8D36_цена_за_выстрел,Y
                                        STA ram_колво_патронов_оружия_lo,X
...
C - - - - - 0x000D1D 00:8D0D: 0A        ASL
C - - - - - 0x000D1E 00:8D0E: 0A        ASL
C - - - - - 0x000D1F 00:8D0F: 90 2A     BCC bra_8D3A_RTS
; нажатая кнопка стрельбы
                                        LDA ram_лимит_пуль_оружия,Y
C - - - - - 0x000D2A 00:8D1A: 85 0D     STA ram_000D   ; кол-во проходов
                                        TXA
                                        TAY
                                        BEQ bra_8D1C_loop
                                        LDY ram_000D
...
bra_8D1C_loop:
C - - - - - 0x000D2C 00:8D1C: B9 A8 05  LDA ram_пули_игрока_аттрибуты,Y
C - - - - - 0x000D2F 00:8D1F: D0 1A     BNE bra_8D3A_RTS
; пусто
C - - - - - 0x000D31 00:8D21: C8        INY
C - - - - - 0x000D32 00:8D22: C6 0D     DEC ram_000D    ; кол-во проходов
C - - - - - 0x000D34 00:8D24: D0 F6     BPL bra_8D1C_loop
; пусто все, можно стрелять
C - - - - - 0x000D36 00:8D26: F0 5A     BMI bra_8D3B    ; jmp
...
C - - - - - 0x000EBC 00:8EAC: 65 01     ADC ram_0000    ; номер пули выстрела
...
bra_91E2:
C - - - - - 0x0011F2 00:91E2: 4C 01 F8  JMP loc_0x01F811_обнуление_пуль_игрока
bra_91E5:
...
C - - - - - 0x001299 00:9289: 4C 01 F8  JMP loc_0x01F811_обнуление_пуль_игрока
