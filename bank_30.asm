...
bra_8CFA:
                                        ...
                                        STA ram_000F    ; Тип Оружия
                                        ASL
                                        EOR ram_0010    ; pl index
                                        TAY
                                        STY ram_0007    ; pl index weapon
;                                        LDA ram_колво_пуль_оружия_lo,Y
;                                        ORA ram_колво_пуль_оружия_hi,Y
;                                        BEQ bra_8CE4_RTS
                                        LDY ram_000F    ; Тип Оружия
                                        LDA tbl_8CFB_lo,y
                                        STA ram_0000
                                        LDA tbl_8CFB_hi,y
                                        STA ram_0001
...
;000E будет свободный (оружие без R)
;ram_000F   ; Тип Оружия
;ram_0010   ; индекс текущего игрока
;ram_0011   ; индекс другова игрока
;ram_0007   ; Индекс оружия текущего игрока
...
C - - - - - 0x000D21 00:8D11: 8A        TXA    ; pl index
C - - - - - 0x000D22 00:8D12: F0 03     BEQ bra_8D17
; 2pl L
C - - - - - 0x000D24 00:8D14: B9 04 8E  LDA tbl_8E04,Y  ; $0A
; 1pl L
bra_8D17:
C - - - - - 0x000D27 00:8D17: A8        TAY
C - - - - - 0x000D28 00:8D18: A9 05     LDA #$05    ; ко-во проходов
