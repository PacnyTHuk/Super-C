...
.export sub_0x001271_flame_разрыв
...
C - - - - - 0x000196 00:8186: A0 3F     LDY #$3F    ; хитбокс сидя
C - - - - - 0x000198 00:8188: 90 06     BCC bra_8190
; диагональные поверхности
C - - - - - 0x00019A 00:818A: A0 5F     LDY #$5F    ; хитбокс лежа
...
C - - - - - 0x0011DD 00:91CD: 9D A8 05  STA ram_пули_игрока_атрибуты_обработки,X
                                        BNE bra_91B0    ; jmp
...
sub_92C0_подготовка_разрывной_пули:
                                        ...
                                        LDA ram_пули_игрока_характеристики,X   ; главной пули
                                        ORA #$07    ; бит игнорировая стен и врагов
