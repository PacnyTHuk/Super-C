...
C - - - - - 0x000033 00:8023: A5 CC     LDA ram_копия_позиция_x_спрайта_игрока
C - - - - - 0x000035 00:8025: C5 CD     CMP ram_копия_позиция_x_спрайта_игрока + $01
...
C - - - - - 0x00005F 00:804F: A5 CE     LDA ram_копия_позиция_y_спрайта_игрока
C - - - - - 0x000061 00:8051: C5 CF     CMP ram_копия_позиция_y_спрайта_игрока + $01
