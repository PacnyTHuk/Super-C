...
C - - - - - 0x000054 00:8044: 20 17 85  JSR sub_8517_обработка_статуса_игрока
...
sub_8517_обработка_статуса_игрока:
...
- D 0 - I - 0x000546 00:8536: 46 86     .byte < ofs_000_8646_05_лежит_на_земле
...
ofs_000_8646_05_лежит_на_земле:
...
- D 0 - I - 0x000A43 00:8A33: 9F 8A     .byte < ofs_003_8A9F_05_лежит_на_земле
...
ofs_003_8A9F_05_лежит_на_земле:
