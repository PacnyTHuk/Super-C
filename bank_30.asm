...
C - - - - - 0x000033 00:8023: A5 CC     LDA ram_00CC_игрок
C - - - - - 0x000035 00:8025: C5 CD     CMP ram_00CC_игрок + $01
...
C - - - - - 0x00005F 00:804F: A5 CE     LDA ram_00CE_игрок
C - - - - - 0x000061 00:8051: C5 CF     CMP ram_00CE_игрок + $01
C - - - - - 0x000063 00:8053: 90 26     BCC bra_807B
C - - - - - 0x000065 00:8055: D0 22     BNE bra_8079
C - - - - - 0x000067 00:8057: A5 5D     LDA ram_005D_конфиг_уровня
...
bra_806D:
C - - - - - 0x00007D 00:806D: A5 CF     LDA ram_00CE_игрок + $01
C - - - - - 0x00007F 00:806F: C5 CE     CMP ram_00CE_игрок
...
bra_8094_loop:
C - - - - - 0x0000A4 00:8094: B5 A0     LDA ram_00A0_игрок,X
...
C - - - - - 0x0000B6 00:80A6: 84 52     STY ram_колво_s
...
C - - - - - 0x0000C7 00:80B7: 95 C6     STA ram_00C6_игрок,X
C - - - - - 0x0000C9 00:80B9: A9 00     LDA #$00
C - - - - - 0x0000CB 00:80BB: 95 C2     STA ram_00C2_игрок,X
C - - - - - 0x0000CD 00:80BD: B5 BC     LDA ram_00BC_игрок,X
C - - - - - 0x0000CF 00:80BF: F0 02     BEQ bra_80C3
C - - - - - 0x0000D1 00:80C1: D6 BC     DEC ram_00BC_игрок,X
bra_80C3:
...
C - - - - - 0x0000DB 00:80CB: 95 C6     STA ram_00C6_игрок,X
...
C - - - - - 0x0000E9 00:80D9: 95 C2     STA ram_00C2_игрок,X
C - - - - - 0x0000EB 00:80DB: B5 BC     LDA ram_00BC_игрок,X
...
C - - - - - 0x000112 00:8102: B4 A0     LDY ram_00A0_игрок,X
...
C - - - - - 0x000145 00:8135: A5 5C     LDA ram_005C_unk
C - - - - - 0x000147 00:8137: F0 0F     BEQ bra_8148
C - - - - - 0x000149 00:8139: B9 F9 81  LDA tbl_81F9,Y
C - - - - - 0x00014C 00:813C: D5 D6     CMP ram_00D6_игрок,X
C - - - - - 0x00014E 00:813E: F0 08     BEQ bra_8148
C - - - - - 0x000150 00:8140: 95 D6     STA ram_00D6_игрок,X
...
C - - - - - 0x000170 00:8160: B5 BC     LDA ram_00BC_игрок,X
...
bra_8190:
C - - - - - 0x0001A0 00:8190: 94 C6     STY ram_00C6_игрок,X
bra_8192:
C - - - - - 0x0001A2 00:8192: B5 BC     LDA ram_00BC_игрок,X
...
C - - - - - 0x0001BD 00:81AD: 95 C6     STA ram_00C6_игрок,X
...
C - - - - - 0x000329 00:8319: A5 5C     LDA ram_005C_unk
...
C - - - - - 0x000339 00:8329: A5 5D     LDA ram_005D_конфиг_уровня
...
C - - - - - 0x000481 00:8471: B9 A0 00  LDA ram_00A0_игрок,Y
...
- - - - - - 0x00049B 00:848B: B9 A0 00  LDA ram_00A0_игрок,Y
...
C - - - - - 0x0004BF 00:84AF: B9 A0 00  LDA ram_00A0_игрок,Y
...
C - - - - - 0x000506 00:84F6: 95 BC     STA ram_00BC_игрок,X
C - - - - - 0x000508 00:84F8: 95 BE     STA ram_00BE_игрок,X
C - - - - - 0x00050A 00:84FA: 95 C0     STA ram_00C0_таймер_респавна_игрока,X
C - - - - - 0x00050C 00:84FC: 95 C2     STA ram_00C2_игрок,X
C - - - - - 0x00050E 00:84FE: 95 C6     STA ram_00C6_игрок,X
C - - - - - 0x000510 00:8500: 95 C8     STA ram_чарж_f_игрока,X
C - - - - - 0x000512 00:8502: 95 CA     STA ram_plr_game_over,X
C - - - - - 0x000514 00:8504: 95 CC     STA ram_00CC_игрок,X
C - - - - - 0x000516 00:8506: 95 CE     STA ram_00CE_игрок,X
C - - - - - 0x000518 00:8508: 95 D2     STA ram_00D2_игрок,X
C - - - - - 0x00051A 00:850A: 95 D0     STA ram_00D0_игрок,X
C - - - - - 0x00051C 00:850C: 95 D4     STA ram_бессмертие_игрока,X
C - - - - - 0x00051E 00:850E: 95 D6     STA ram_00D6_игрок,X
C - - - - - 0x000520 00:8510: 95 D8     STA ram_00D8_игрок,X
...
bra_8519:
C - - - - - 0x000529 00:8519: 95 D8     STA ram_00D8_игрок,X
C - - - - - 0x00052B 00:851B: BD 4C 05  LDA ram_позиция_x_спрайта_игрока,X
C - - - - - 0x00052E 00:851E: 95 CC     STA ram_00CC_игрок,X
C - - - - - 0x000530 00:8520: A5 5D     LDA ram_005D_конфиг_уровня
C - - - - - 0x000532 00:8522: F0 03     BEQ bra_8527
C - - - - - 0x000534 00:8524: 4C 24 8A  JMP loc_8A24
bra_8527:
C - - - - - 0x000537 00:8527: B5 A0     LDA ram_00A0_игрок,X
...
C - - - - - 0x000552 00:8542: 95 C2     STA ram_00C2_игрок,X
...
bra_854C:
C - - - - - 0x00055C 00:854C: 95 CE     STA ram_00CE_игрок,X
ofs_000_854E_08:
ofs_003_854E_08:
...
C - - - - - 0x000568 00:8558: 95 CC     STA ram_00CC_игрок,X
...
loc_8586:
C D 0 - - - 0x000596 00:8586: F6 A0     INC ram_00A0_игрок,X
bra_8588_RTS:
...
C - - - - - 0x00062A 00:861A: 95 C0     STA ram_00C0_таймер_респавна_игрока,X
...
C - - - - - 0x000666 00:8656: D6 C0     DEC ram_00C0_таймер_респавна_игрока,X
...
bra_866A:
C - - - - - 0x00067A 00:866A: 95 A0     STA ram_00A0_игрок,X
C - - - - - 0x00067C 00:866C: A9 00     LDA #$00
C - - - - - 0x00067E 00:866E: 95 C0     STA ram_00C0_таймер_респавна_игрока,X
bra_8670_RTS:
...
ofs_000_8671_06:
C - - J - - 0x000681 00:8671: D6 C0     DEC ram_00C0_таймер_респавна_игрока,X
...
C - - - - - 0x00068F 00:867F: 95 C0     STA ram_00C0_таймер_респавна_игрока,X
...
C - - - - - 0x00069C 00:868C: D6 C0     DEC ram_00C0_таймер_респавна_игрока,X
...
bra_869C:
C - - - - - 0x0006AC 00:869C: B5 C0     LDA ram_00C0_таймер_респавна_игрока,X
...
bra_873A:
loc_873A:
C D 0 - - - 0x00074A 00:873A: B5 A6     LDA ram_скорость_игрока_y_младш,X
...
sub_879B:
C - - - - - 0x0007AB 00:879B: B5 D2     LDA ram_00D2_игрок,X
...
C - - - - - 0x0007DE 00:87CE: 95 CC     STA ram_00CC_игрок,X
bra_87D0:
...
C - - - - - 0x000815 00:8805: B5 D8     LDA ram_00D8_игрок,X
...
C - - - - - 0x000855 00:8845: B4 CC     LDY ram_00CC_игрок,X
C - - - - - 0x000857 00:8847: F0 02     BEQ bra_884B_RTS
C - - - - - 0x000859 00:8849: 95 CC     STA ram_00CC_игрок,X
bra_884B_RTS:
...
bra_88B4:
C - - - - - 0x0008C4 00:88B4: 95 D8     STA ram_00D8_игрок,X
C - - - - - 0x0008C6 00:88B6: BD 32 05  LDA ram_позиция_y_спрайта_игрока,X
C - - - - - 0x0008C9 00:88B9: 95 CE     STA ram_00CE_игрок,X
C - - - - - 0x0008CB 00:88BB: A5 5D     LDA ram_005D_конфиг_уровня
C - - - - - 0x0008CD 00:88BD: F0 03     BEQ bra_88C2
C - - - - - 0x0008CF 00:88BF: 4C 28 8C  JMP loc_8C28
bra_88C2:
C - - - - - 0x0008D2 00:88C2: B5 A0     LDA ram_00A0_игрок,X
...
C - - - - - 0x000935 00:8925: 95 CE     STA ram_00CE_игрок,X
...
C - - - - - 0x000944 00:8934: B5 D8     LDA ram_00D8_игрок,X
...
C - - - - - 0x0009AE 00:899E: 95 CE     STA ram_00CE_игрок,X
bra_89A0_RTS:
loc_89A0_RTS:
...
loc_8A24:
C D 0 - - - 0x000A34 00:8A24: B5 A0     LDA ram_00A0_игрок,X
...
C - - - - - 0x000A8E 00:8A7E: F6 A0     INC ram_00A0_игрок,X
bra_8A80_RTS:
...
C - - - - - 0x000BBC 00:8BAC: 95 C6     STA ram_00C6_игрок,X
...
bra_8BD4:
C - - - - - 0x000BE4 00:8BD4: B4 D0     LDY ram_00D0_игрок,X
...
sub_8C18:
C - - - - - 0x000C28 00:8C18: B4 D0     LDY ram_00D0_игрок,X
...
loc_8C28:
C D 0 - - - 0x000C38 00:8C28: B5 A0     LDA ram_00A0_игрок,X
...
C - - - - - 0x000C56 00:8C46: B5 CE     LDA ram_00CE_игрок,X
...
C - - - - - 0x000C6D 00:8C5D: B5 D2     LDA ram_00D2_игрок,X
...
C - - - - - 0x000C92 00:8C82: 95 CE     STA ram_00CE_игрок,X
bra_8C84:
...
C - - - - - 0x000CA6 00:8C96: 24 5C     BIT ram_005C_unk
...
C - - - - - 0x000CB5 00:8CA5: B5 D8     LDA ram_00D8_игрок,X
...
C - - - - - 0x000CEC 00:8CDC: B4 CE     LDY ram_00CE_игрок,X
...
C - - - - - 0x000D40 00:8D30: D6 BE     DEC ram_00BE_игрок,X
C - - - - - 0x000D42 00:8D32: 10 06     BPL bra_8D3A_RTS
C - - - - - 0x000D44 00:8D34: A9 06     LDA #$06
bra_8D36:
C - - - - - 0x000D46 00:8D36: 95 BE     STA ram_00BE_игрок,X
...
C - - - - - 0x000DA3 00:8D93: 95 BC     STA ram_00BC_игрок,X
...
C - - - - - 0x000DAD 00:8D9D: BD 32 05  LDA ram_позиция_y_спрайта_игрока,X
C - - - - - 0x000DB0 00:8DA0: 85 03     STA ram_0003
C - - - - - 0x000DB2 00:8DA2: BD 4C 05  LDA ram_позиция_x_спрайта_игрока,X
...
C - - - - - 0x000E43 00:8E33: 9D 98 05  STA ram_пули_игрока_атрибуты_спрайта,X
...
loc_0x001191:
C D 0 - - - 0x001191 00:9181: A2 0F     LDX #con_макс_индекс_пули_игрока
bra_9183_loop:
...
C - - - - - 0x00119B 00:918B: A2 0F     LDX #con_макс_индекс_пули_игрока
C - - - - - 0x00119D 00:918D: A5 1B     LDA ram_счетчик_кадров_1
...
C - - - - - 0x0011A9 00:9199: BD 98 05  LDA ram_пули_игрока_атрибуты_спрайта,X 
C - - - - - 0x0011AC 00:919C: 99 4E 05  STA ram_атрибуты_спрайта_пули_игрока,Y
...
C - - - - - 0x0011FB 00:91EB: A5 5D     LDA ram_005D_конфиг_уровня
...
C - - - - - 0x0012EF 00:92DF: 9D 98 05  STA ram_пули_игрока_атрибуты_спрайта,X
...
loc_0x001411:
C D 0 - - - 0x001411 00:9401: A5 5C     LDA ram_005C_unk
...
C - - - - - 0x001440 00:9430: A4 51     LDY ram_номер_круга
...
bra_943F_1st_loop:
C - - - - - 0x00144F 00:943F: A4 52     LDY ram_колво_s
...
ofs_006_945B_01:
C - - J - - 0x00146B 00:945B: A5 1B     LDA ram_счетчик_кадров_1
...
C - - - - - 0x001496 00:9486: A5 94     LDA ram_0094_конфиг_уровня
...
C - - - - - 0x00150D 00:94FD: A5 1B     LDA ram_счетчик_кадров_1
...
C - - - - - 0x001524 00:9514: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
C - - - - - 0x001527 00:9517: A5 11     LDA ram_0011
C - - - - - 0x001529 00:9519: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
...
C - - - - - 0x001566 00:9556: 9D 3C 05  STA ram_позиция_x_спрайта_врага_и_пуль,X
C - - - - - 0x001569 00:9559: A5 10     LDA ram_0010
C - - - - - 0x00156B 00:955B: 9D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль,X
...
C - - - - - 0x001598 00:9588: A5 51     LDA ram_номер_круга
...
bra_95B5:
C - - - - - 0x0015C5 00:95B5: A5 1B     LDA ram_счетчик_кадров_1
...
C - - - - - 0x001678 00:9668: 65 1B     ADC ram_счетчик_кадров_1
...
C - - - - - 0x001C45 00:9C35: 85 5D     STA ram_005D_конфиг_уровня
...
sub_9DA0:
C - - - - - 0x001DB0 00:9DA0: A5 1B     LDA ram_счетчик_кадров_1
...
bra_9DF8:
C - - - - - 0x001E08 00:9DF8: A5 1B     LDA ram_счетчик_кадров_1
...
C - - - - - 0x002205 00:A1F5: 95 D2     STA ram_00D2_игрок,X
bra_A1F7:
...
C - - - - - 0x00221D 00:A20D: 95 D2     STA ram_00D2_игрок,X
...
C - - - - - 0x002267 00:A257: A5 1B     LDA ram_счетчик_кадров_1
...
C - - - - - 0x00227F 00:A26F: B5 CC     LDA ram_00CC_игрок,X
...
C - - - - - 0x002294 00:A284: 94 D2     STY ram_00D2_игрок,X
bra_A286:
...
C - - - - - 0x0022A9 00:A299: 95 A0     STA ram_00A0_игрок,X
...
C D 1 - - - 0x0023C7 00:A3B7: A5 61     LDA ram_0061_конфиг_уровня
...
ofs_012_A44B_01:
C - - J - - 0x00245B 00:A44B: A5 1B     LDA ram_счетчик_кадров_1
...
bra_A454:
C - - - - - 0x002464 00:A454: 8D 22 05  STA ram_позиция_y_спрайта_врага_и_пуль
C - - - - - 0x002467 00:A457: A5 1B     LDA ram_счетчик_кадров_1
...
bra_A461:
C - - - - - 0x002471 00:A461: 8D 08 05  STA ram_кадр_врага_и_пуль
C - - - - - 0x002474 00:A464: A9 03     LDA #$03
C - - - - - 0x002476 00:A466: 8D 56 05  STA ram_атрибуты_спрайта_врага_и_пуль
...
sub_A495:
C - - - - - 0x0024A5 00:A495: A5 1B     LDA ram_счетчик_кадров_1
