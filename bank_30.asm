...
C - - - - - 0x0000CB 00:80BB: 95 C2     STA ram_флаг_статус_игрока,X
...
C - - - - - 0x0000E9 00:80D9: 95 C2     STA ram_флаг_статус_игрока,X
...
C - - - - - 0x00050C 00:84FC: 95 C2     STA ram_флаг_статус_игрока,X
...
; leon опт
                                        ...
                                        JMP (ram_0000)
tbl_852C_lo:
- D 0 - I - 0x00053C 00:852C: 3E 85     .byte < ofs_000_853E_00
- D 0 - I - 0x00053E 00:852E: 5B 85     .byte < ofs_000_855B_01
- D 0 - I - 0x000540 00:8530: 99 85     .byte < ofs_000_8599_02
- D 0 - I - 0x000542 00:8532: A9 85     .byte < ofs_000_85A9_03
- D 0 - I - 0x000544 00:8534: C6 85     .byte < ofs_000_85C6_04
- D 0 - I - 0x000546 00:8536: 46 86     .byte < ofs_000_8646_05
- D 0 - I - 0x000548 00:8538: 71 86     .byte < ofs_000_8671_06
- D 0 - I - 0x00054A 00:853A: 82 86     .byte < ofs_000_8682_07
- D 0 - I - 0x00054C 00:853C: 4E 85     .byte < ofs_000_854E_08
tbl_852C_hi:
- D 0 - I - 0x00053C 00:852C: 3E 85     .byte > ofs_000_853E_00
- D 0 - I - 0x00053E 00:852E: 5B 85     .byte > ofs_000_855B_01
- D 0 - I - 0x000540 00:8530: 99 85     .byte > ofs_000_8599_02
...
C - - - - - 0x000552 00:8542: 95 C2     STA ram_флаг_статус_игрока,X
...
; 1путин
                                        ...
                                        BPL bra_873B
                                        LDA ram_индикатор_прыжка_игрока,X
                                        AND ram_удержанная_кнопка,X
                                        STA ram_индикатор_прыжка_игрока,X
                                        ROL
                                        BCS bra_873B
                                        LDA #$60 ; НЕТ УДЕРЖАНИЯ
                                        BNE bra_873C
bra_873B:
                                        LDA #$23
bra_873C:
...
C - - - - - 0x00074D 00:873D: 69 23     ADC ram_0000
...
C - - - - - 0x0007B5 00:87A5: A4 AE     LDY ram_состояние_игрока_в_полете
