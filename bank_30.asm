...
C - - - - - 0x00003D 00:802D: 05 B1     ORA ram_00B0_копия_удержанная_кнопка + $01
...
C - - - - - 0x000067 00:8057: A5 5D     LDA ram_конфиг_уровня_вид
C - - - - - 0x000069 00:8059: F0 08     BEQ bra_8063_вид_сбоку
; вид сверху
...
bra_8094_loop:
C - - - - - 0x0000A4 00:8094: B5 A0     LDA ram_статус_игрока,X
...
bra_8527_вид_сбоку:
C - - - - - 0x000537 00:8527: B5 A0     LDA ram_статус_игрока,X
...
bra_88C2_вид_сбоку:
C - - - - - 0x0008D2 00:88C2: B5 A0     LDA ram_статус_игрока,X
...
loc_8A24:
C D 0 - - - 0x000A34 00:8A24: B5 A0     LDA ram_статус_игрока,X
...
C - - - - - 0x000A8E 00:8A7E: F6 A0     INC ram_статус_игрока,X
bra_8A80_RTS:
...
loc_8C28:
C D 0 - - - 0x000C38 00:8C28: B5 A0     LDA ram_статус_игрока,X
...
C - - - - - 0x000D40 00:8D30: D6 BE     DEC ram_кд_оружия_m,X
C - - - - - 0x000D42 00:8D32: 10 06     BPL bra_8D3A_RTS
C - - - - - 0x000D44 00:8D34: A9 06     LDA #$06
bra_8D36:
C - - - - - 0x000D46 00:8D36: 95 BE     STA ram_кд_оружия_m,X
...
C - - - - - 0x000DFC 00:8DEC: D9 FD 8D  CMP tbl_лимит_пуль_оружия,Y
...
loc_0x001199:
C D 0 - - - 0x001199 00:9189: A0 07     LDY #con_макс_индекс_кадр_пули_игрока
