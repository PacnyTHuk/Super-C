...
C - - - - - 0x014390 05:8380: A5 23     LDA ram_0023
C - - - - - 0x014392 05:8382: 65 5B     ADC ram_005B
C - - - - - 0x014394 05:8384: 85 23     STA ram_0023
...
bra_8573:
C - - - - - 0x014583 05:8573: A5 1B     LDA ram_frm_cnt
C - - - - - 0x014585 05:8575: E5 23     SBC ram_0023
C - - - - - 0x014587 05:8577: 85 23     STA ram_0023
C - - - - - 0x014589 05:8579: A5 23     LDA ram_0023
...
sub_867C:
C - - - - - 0x01468C 05:867C: A5 23     LDA ram_0023
...
bra_86CF:
C - - - - - 0x0146DF 05:86CF: A5 23     LDA ram_0023
C - - - - - 0x0146E1 05:86D1: 65 1B     ADC ram_frm_cnt
C - - - - - 0x0146E3 05:86D3: 85 23     STA ram_0023
...
bra_87B1_loop:
C - - - - - 0x0147C1 05:87B1: 99 D6 07  STA ram_07D0 + $06,Y    ; !!! ; 07D6 07D7 07D8 07D9 
...
C - - - - - 0x015504 05:94F4: A5 23     LDA ram_0023
...
C - - - - - 0x015516 05:9506: A5 23     LDA ram_0023
...
C - - - - - 0x0156E6 05:96D6: 8D F0 07  STA ram_chr_bank
C - - - - - 0x0156E9 05:96D9: A9 0A     LDA #con_chr_bank + $0A
C - - - - - 0x0156EB 05:96DB: 8D F1 07  STA ram_chr_bank + $01
