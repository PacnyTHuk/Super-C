...
C - - - - - 0x010192 04:8182: 20 B7 A6  JSR sub_0x0066C7_прибавить_позицию_спрайта_к_скорости_камеры_X_Y
...
C - - - - - 0x0101A8 04:8198: 4C D7 A2  JMP loc_0x0062E7_увеличить_состояние_объекта
...
C - - - - - 0x0101B4 04:81A4: 20 D3 A6  JSR sub_0x0066E3_обработка_позиции_Y_X_объекта_от_скорости
...
C - - - - - 0x011C29 04:9C19: 20 75 A4  JSR sub_0x006485_убить_объект
