...
bra_A10E_коллизия_объектов_или_пуль_с_игроком:
                                        STX ram_0011    ; save индекс игрока
...
; есть попадание по игроку
                                        ...
                                        BEQ bra_A13A
                                        AND #$0C    ; 04+08 bit - бронебойная пуля, пуля сжигает пули игроков
                                        BNE bra_A13A
...
; пуля игрока против пули объекта
                                        AND #$03    ; биты что это пуля или пуля пролетающая насквозь стен
                                        BEQ bra_A1C0
; обычная пуля объекта
                                        LDA ram_пули_игрока_характеристики,X
                                        AND #$06    ; биты сжигания
                                        BEQ bra_A1BE_RTS
; ОЧИСТИТЬ ПУЛЮ ОБЪЕКТА
                                        ...
                                        RTS
; пуля объекта против пули игрока
bra_A1C0:
                                        LDA ram_характеристики_пуль_объектов,Y
                                        AND #$08    ; бит - пуля сжигает пули игроков
                                        BEQ bra_A1FO_RTS
                                        LDA ram_пули_игрока_характеристики,X
                                        AND #$06    ; биты сжигания
...
C - - - - - 0x006EE6 01:AED6: 20 D3 A6  JSR sub_A6D3_обработка_позиции_Y_X_объекта_от_скорости
                                        LDA ram_характеристики_пуль_объектов,X
                                        AND #$02    ; бит - пуля пролетает насквозь стен
                                        BNE bra_AEEE_RTS
