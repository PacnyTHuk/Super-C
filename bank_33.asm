...
C - - - - - 0x0061D4 01:A1C4: 30 F8     BPL bra_A1C6_объекты
; объекты у которых стоит флаг N, не будет проверок на пули игрока
                                        LDA ram_пули_игрока_характеристики,X
                                        AND #$C0    ; биты прокачки сжигания пуль
                                        BEQ bra_A1BE_RTS
                                        LDA ram_кадр_врага_и_пуль,Y
                                        CMP #$05    ; обычная пуля
                                        BNE bra_A1BE_RTS
; только обычная пуля 02
...
C - - - - - 0x0061F7 01:A1E7: D0 D5     BCC bra_A1BE_RTS
                                        ...
                                        BNE bra_A1FO_RTS
; касание объектов
                                        LDA ram_номер_действия_пули_игрока,X
...
; grenade_launcher
                                        LDA #$80
                                        STA ram_номер_действия_пули_игрока,X
...
C - - - - - 0x006207 01:A1F7: B9 76 06  LDA ram_жизни_объектов,Y
...
bra_A204:
C - - - - - 0x006214 01:A204: 99 76 06  STA ram_жизни_объектов,Y
...
C - - - - - 0x0064A1 01:A491: 9D 76 06  STA ram_жизни_объектов,X
...
C - - - - - 0x0065AF 01:A59F: BD 76 06  LDA ram_жизни_объектов,X
...
C - - - - - 0x006BC0 01:ABB0: 9D 76 06  STA ram_жизни_объектов,X
...
C - - - - - 0x00789B 01:B88B: 9D 76 06  STA ram_жизни_объектов,X
...
C - - - - - 0x007987 01:B977: 9D 76 06  STA ram_жизни_объектов,X
...
C - - - - - 0x0079EE 01:B9DE: 9D 76 06  STA ram_жизни_объектов,X
