...
- D 1 - - - 0x006014 01:A004: F0        .byte $F0, $FA, $1E, $0A    ; 04 пуля врага
...
- D 1 - - - 0x006024 01:A014: E1        .byte $E1, $D3, $3C, $58    ; 14 пасть 6й лвл
- D 1 - - - 0x006028 01:A018: D1        .byte $D1, $DB, $6C, $48    ; 18
- D 1 - - - 0x00602C 01:A01C: D1        .byte $D1, $EB, $5C, $28    ; 1C 7й лвл пасть плюет
...
; DF-FF новый хитбокс для ракеты (как у гранаты)
                                        .byte $e4, $e4, $2a, $2a    ; A0
                                        .byte $e8, $e8, $22, $22    ; A4
                                        .byte $dd, $e4, $38, $2a    ; A8
                                        .byte $dc, $dc, $3a, $3a    ; AC
...
bra_A22E_loop:
C - - - - - 0x00623E 01:A22E: 86 10     STX ram_0010    ; save x объекта
