...
; игроки
C - - - - - 0x00C138 03:8128: A0 17     LDY ram_макс_индекс_пули_игрока
bra_812A_loop:
...
- - - - - - 0x00C225 03:8215: 28 84     .word _off030_8428_08
...
- - - - - - 0x00C23F 03:822F: 31 85     .word _off030_8531_15
- - - - - - 0x00C241 03:8231: 32 85     .word _off030_8532_16
- - - - - - 0x00C243 03:8233: 33 85     .word _off030_8533_17
- - - - - - 0x00C245 03:8235: 38 85     .word _off030_8538_18
...
_off030_8428_08:
- - - - - - 0x00C438 03:8428: 0C        .byte @end - * - $01   ; total data size
;                                              --------------------- spr_Y
;                                              |    ---------------- spr_T
;                                              |    |    ----------- spr_A
;                                              |    |    |    ------ spr_X
;                                              |    |    |    |
- - - - - - 0x00C439 03:8429: F8        .byte $F8, $93, $00, $FC   ; 
- - - - - - 0x00C43D 03:842D: F8        .byte $F8, $91, $00, $F4   ; 
- - - - - - 0x00C441 03:8431: F8        .byte $F8, $91, $40, $04   ; 
@end:
...
_off030_8531_15:
- - - - - - 0x00C541 03:8531: C5        .byte $C5   ; 



_off030_8532_16:
- - - - - - 0x00C542 03:8532: BC        .byte $BC   ; 



_off030_8533_17:
- - - - - - 0x00C543 03:8533: 04        .byte @end - * - $01   ; total data size
;                                              --------------------- spr_Y
;                                              |    ---------------- spr_T
;                                              |    |    ----------- spr_A
;                                              |    |    |    ------ spr_X
;                                              |    |    |    |
- - - - - - 0x00C544 03:8534: F8        .byte $F8, $7B, $00, $FC   ; 
@end:



_off030_8538_18:
- - - - - - 0x00C548 03:8538: 04        .byte @end - * - $01   ; total data size
;                                              --------------------- spr_Y
;                                              |    ---------------- spr_T
;                                              |    |    ----------- spr_A
;                                              |    |    |    ------ spr_X
;                                              |    |    |    |
- - - - - - 0x00C549 03:8539: F8        .byte $F8, $7B, $80, $FC   ; 
@end:
...
_off030_8EE5_B9:
- - - - - - 0x00CEF5 03:8EE5: 04        .byte @end - * - $01   ; total data size
;                                              --------------------- spr_Y
;                                              |    ---------------- spr_T
;                                              |    |    ----------- spr_A
;                                              |    |    |    ------ spr_X
;                                              |    |    |    |
- - - - - - 0x00CEF6 03:8EE6: 00        .byte $00, $D9, $00, $00   ; 
@end:
...
;                                              |    |    |    ------ spr_X
;                                              |    |    |    |
- - - - - - 0x00D13F 03:912F: F1        .byte $F1, $1D, $00, $F8   ; 
- - - - - - 0x00D143 03:9133: F1        .byte $F1, $1F, $00, $00   ; 
- - - - - - 0x00D147 03:9137: EF        .byte $EF, $21, $00, $08   ; 
...
;                                              |    |    |    ------ spr_X
;                                              |    |    |    |
- - - - - - 0x00D1EC 03:91DC: 04        .byte $04, $23, $00, $F0   ; 
- - - - - - 0x00D1F0 03:91E0: 05        .byte $05, $25, $00, $F8   ; 
- - - - - - 0x00D1F4 03:91E4: 05        .byte $05, $27, $00, $00   ; 
- - - - - - 0x00D1F8 03:91E8: 05        .byte $05, $29, $00, $08   ; 
...
;                                              |    |    |    ------ spr_X
;                                              |    |    |    |
- - - - - - 0x00D296 03:9286: F7        .byte $F7, $1D, $00, $F8   ; 
- - - - - - 0x00D29A 03:928A: F7        .byte $F7, $1F, $00, $00   ; 
- - - - - - 0x00D29E 03:928E: F4        .byte $F4, $21, $00, $08   ; 
- - - - - - 0x00D2A2 03:9292: 07        .byte $07, $E5, $00, $F8   ; 
- - - - - - 0x00D2A6 03:9296: 05        .byte $05, $E7, $00, $00   ; 
...
;                                              |    |    |    ------ spr_X
;                                              |    |    |    |
- - - - - - 0x00D2AB 03:929B: F8        .byte $F8, $1D, $00, $F8   ; 
- - - - - - 0x00D2AF 03:929F: F8        .byte $F8, $1F, $00, $00   ; 
- - - - - - 0x00D2B3 03:92A3: F5        .byte $F5, $21, $00, $08   ; 
- - - - - - 0x00D2B7 03:92A7: 07        .byte $07, $E5, $00, $F8   ; 
- - - - - - 0x00D2BB 03:92AB: 05        .byte $05, $E7, $00, $00   ; 
